...
const Footer = () => {
  ...
  return (
    <footer className="pt-20 pb-24 md:pb-12 bg-transparent dark:bg-transparent backdrop-blur-[2px] border-t dark:border-white/5 border-black/5 relative overflow-hidden min-h-[480px] contain-layout">

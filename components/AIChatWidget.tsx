...
export const AIChatWidget = () => {
  ...
  // ONLY THIS FUNCTION IS UPDATED FOR STREAMING
  const handleSendMessage = async (e?: React.FormEvent) => {
    ...
    // Empty AI message — response stream yahan fill hoga
    setMessages((prev) => [
      ...prev,
      {
        id: botMsgId,

...
import OrganicTrainingGuideClient from "../../organic-mushroom-farming-training-india/OrganicTrainingGuideClient";

export const dynamic = "error";
export const revalidate = false;

const PAGE_URL = "https://organicmushroomsfarm.com/blog/mushroom-farming-training";
...
export default function BlogMushroomFarmingTrainingPage() {

      ...
      <article className="max-w-5xl mx-auto px-4 relative z-10 space-y-8 pb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <AnimatePresence mode="popLayout">
              {prices[activeTab].map((item, i) => (
                ...
                >
                  <h3 className="font-bold dark:text-white text-slate-900 text-[11px] md:text-[12px] mb-3">{item.type}</h3>
                  <div className="text-lg md:text-xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-amber-500 mb-3">{item.avg}</div>
        ...
        <section className="grid lg:grid-cols-2 gap-6">
          <div className="bg-white/5 dark:bg-white/[0.02] backdrop-blur-sm p-6 md:p-8 rounded-[2rem] border dark:border-white/10 border-black/10 shadow-sm">
            <h2 className="text-[13px] md:text-[15px] font-bold dark:text-white text-slate-900 mb-6 flex items-center gap-2">
              <Table className="text-emerald-500 w-4 h-4" /> State-wise Wholesale Rates
            </h2>
          ...
          <div className="space-y-6">
            <div className="bg-emerald-500/5 backdrop-blur-sm p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 shadow-sm">
              <h3 className="text-[12px] md:text-[14px] font-bold dark:text-white text-slate-900 mb-3 flex items-center gap-2">
                <BarChart className="text-emerald-500 w-3.5 h-3.5" /> Market Demand Analysis
              </h3>
              <p className="dark:text-slate-400 text-slate-600 text-[9px] md:text-[10px] leading-relaxed mb-4">
            ...
            <div className="bg-amber-500/5 backdrop-blur-sm p-6 md:p-8 rounded-[2rem] border border-amber-500/20 shadow-sm">
              <h3 className="text-[11px] md:text-[13px] font-bold dark:text-white text-slate-900 mb-2">Want to setup bulk daily supply?</h3>
              <p className="text-[9px] md:text-[10px] dark:text-slate-400 text-slate-600 mb-4">We provide contracted, continuous high-quality B2B supply for hotels, restaurants, and cloud kitchens. Explore our <Link href="/spawn-seed" className="text-amber-600 font-bold hover:underline">high-yield spawn</Link>.</p>
        ...
        <section className="bg-white/5 dark:bg-white/[0.02] backdrop-blur-sm p-8 md:p-12 rounded-[2.5rem] border dark:border-white/10 border-black/10 text-center shadow-sm relative overflow-hidden">
           ...
           <div className="relative z-10">
              <h2 className="text-[15px] md:text-[18px] font-bold dark:text-white text-slate-900 mb-3">Need Accurate Pricing for Your Area?</h2>
              <p className="text-[9px] md:text-[10px] dark:text-slate-400 text-slate-600 mb-6 max-w-xl mx-auto leading-relaxed">

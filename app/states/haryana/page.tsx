...
export const metadata: Metadata = {
  ...
  description:
    "Find premium mushroom farming training, commercial setups, spawn supply, and agribusiness resources across cities in Haryana.",
  alternates: {
...
export default function HaryanaPage() {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://organicmushroomsfarm.com/states/haryana#breadcrumb",
        itemListElement: [
          {
            "@type": "ListItem",
            position: 1,
        ...
        <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <header className="mb-10">
            <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-3 flex items-center gap-2.5">
              ...
              <span>Haryana Cities</span>
            </h1>
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed">
              Select a city in Haryana to find local mushroom farming training centers, consultants, and premium spawn suppliers.
            </p>
          </header>

          {/* Cities Grid Section */}
          <section
            aria-label="Haryana City Hubs"
          ...
          <section className="glass rounded-2xl p-6 sm:p-8 border border-black/5 dark:border-white/5">
            <h2 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white mb-3">
              Mushroom Farming Legacy &amp; Commercial Hubs in Haryana
            </h2>
            <p className="text-xs sm:text-sm leading-relaxed text-slate-700 dark:text-slate-300 mb-3">
              Haryana is historically one of the pioneers of seasonal and commercial White Button mushroom cultivation in India, with major centers in Murthal, Sonipat, Gurugram, and Faridabad. Its close proximity to the Delhi NCR wholesale markets and abundant wheat straw supplies give growers superior logistic and profit advantages.
            </p>
            <p className="text-xs sm:text-sm leading-relaxed text-slate-700 dark:text-slate-300">
              Growers across Haryana can enroll in our hands-on{" "}
              <Link
                href="/training"
              ...
              , or consult our engineering team for hi-tech PUF-insulated{" "}
              <Link

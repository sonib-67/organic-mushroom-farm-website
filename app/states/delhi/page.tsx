...
export const metadata: Metadata = {
  title: "Mushroom Farming in Delhi | Cities",
  description:
    ...
    "@graph": [
      {
        ...
        url: "https://organicmushroomsfarm.com/states/delhi",
        name: "Mushroom Farming in Delhi | Cities",
        description:
          "Find mushroom farming training, commercial setups, and resources across cities in Delhi NCR.",
        isPartOf: {
          "@type": "WebSite",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://organicmushroomsfarm.com/states/delhi#breadcrumb",
        itemListElement: [
          {
            "@type": "ListItem",
            position: 1,
        ...
        <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <header className="mb-10">
            <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-3 flex items-center gap-2.5">
              ...
              <span>Delhi Cities</span>
            </h1>
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed">
              Select a city in Delhi NCR to find local mushroom farming training centers, consultants, and spawn suppliers.
            </p>
          </header>

          {/* Cities Grid Section */}
          <section
            aria-label="Delhi NCR City Hubs"
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12"
          >
            {/* New Delhi Card */}
            <Link
              href="/cities/delhi/new-delhi"
            ...
            >
              ...
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mb-6 leading-relaxed">
                Mushroom training, cultivation resources, and commercial setups in Delhi NCR.
              </p>
          ...
          <section className="glass rounded-2xl p-6 sm:p-8 border border-black/5 dark:border-white/5">
            <h2 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white mb-3">
              Commercial Mushroom Market &amp; Production in Delhi NCR
            </h2>
            <p className="text-xs sm:text-sm leading-relaxed text-slate-700 dark:text-slate-300 mb-3">
              Delhi NCR constitutes one of the largest consumer markets for fresh edible mushrooms in South Asia. Anchored by the Asia&apos;s largest fruit &amp; vegetable terminal at Azadpur Mandi, luxury hotels, supermarkets, and cloud kitchens, demand for Button, Oyster, Portobello, and Enoki mushrooms consistently outstrips local supply.
            </p>
            <p className="text-xs sm:text-sm leading-relaxed text-slate-700 dark:text-slate-300">
              Explore city-specific resources on our dedicated hub for{" "}
              <Link
                href="/cities/delhi/new-delhi"
                className="text-[#7C3AED] dark:text-purple-400 font-semibold hover:underline"
              >
                Mushroom Farming in New Delhi
              </Link>
              ...
              , or consult our engineering division for climate-controlled{" "}
              <Link

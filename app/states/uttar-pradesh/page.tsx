...
export const metadata: Metadata = {
  ...
  description:
    "Find premium mushroom farming training, commercial setups, spawn supply, and agribusiness resources across cities in Uttar Pradesh.",
  alternates: {
...
export default function UttarPradeshPage() {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://organicmushroomsfarm.com/states/uttar-pradesh#breadcrumb",
        itemListElement: [
          {
            "@type": "ListItem",
            position: 1,
        ...
        <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <header className="mb-10">
            <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-3 flex items-center gap-2.5">
              ...
              <span>Uttar Pradesh Cities</span>
            </h1>
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed">
              Select a city in Uttar Pradesh to find local mushroom farming training centers, consultants, and premium spawn suppliers.
            </p>
          </header>

          {/* Cities Grid Section */}
          <section
            aria-label="Uttar Pradesh City Hubs"
          ...
          <section className="glass rounded-2xl p-6 sm:p-8 border border-black/5 dark:border-white/5">
            <h2 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white mb-3">
              Mushroom Production Capital &amp; Agro-Industrial Scale in Uttar Pradesh
            </h2>
            <p className="text-xs sm:text-sm leading-relaxed text-slate-700 dark:text-slate-300 mb-3">
              Uttar Pradesh is one of India&apos;s foremost agricultural powerhouses and largest producers of seasonal Button mushrooms. With huge agricultural straw residues, extensive mandi networks in Lucknow, Kanpur, Agra, and Varanasi, and government subsidies under NHM and ODOP, commercial mushroom farming is expanding rapidly.
            </p>
            <p className="text-xs sm:text-sm leading-relaxed text-slate-700 dark:text-slate-300">
              Growers across Uttar Pradesh can join our practical{" "}
              <Link
                href="/training"

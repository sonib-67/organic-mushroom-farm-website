...
export const metadata: Metadata = {
  ...
  description:
    "Find mushroom farming training, commercial setups, and resources across cities in Chhattisgarh.",
  alternates: {
...
export default function ChhattisgarhPage() {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://organicmushroomsfarm.com/states/chhattisgarh#breadcrumb",
        itemListElement: [
          {
            "@type": "ListItem",
            position: 1,
    ...
    <>
      ...
      <main className="pt-6 sm:pt-8 pb-16 min-h-screen bg-transparent relative z-10 font-sans">
        <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Cities Grid Section */}
          <section
            aria-label="Chhattisgarh City Hubs"
          ...
          <section className="glass rounded-2xl p-6 sm:p-8 border border-black/5 dark:border-white/5">
            <h2 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white mb-3">
              Mushroom Cultivation Potential in Chhattisgarh
            </h2>
            <p className="text-xs sm:text-sm leading-relaxed text-slate-700 dark:text-slate-300 mb-3">
              Known as the &quot;Rice Bowl of Central India,&quot; Chhattisgarh provides unparalleled cost advantages with widespread availability of clean paddy straw substrate. This allows farmers and agri-entrepreneurs to produce Oyster mushrooms, Paddy Straw mushrooms, and heat-tolerant Milky mushrooms at exceptionally competitive margins.
            </p>

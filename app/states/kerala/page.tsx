...
export const metadata: Metadata = {
  ...
  description:
    "Find mushroom farming training, commercial setups, and resources across cities in Kerala.",
  alternates: {
...
export default function KeralaPage() {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://organicmushroomsfarm.com/states/kerala#breadcrumb",
        itemListElement: [
          {
            "@type": "ListItem",
            position: 1,
        ...
        <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="glass rounded-2xl p-6 sm:p-8 border border-black/5 dark:border-white/5">
            <h2 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white mb-3">
              Mushroom Cultivation Potential in Kerala&apos;s Tropical Climate
            </h2>
            <p className="text-xs sm:text-sm leading-relaxed text-slate-700 dark:text-slate-300 mb-3">
              Kerala&apos;s coastal tropical humidity creates natural conditions for Oyster mushrooms (<em>Pleurotus</em>) and heat-resistant Milky mushrooms (<em>Calocybe indica</em>). High local health consciousness and prominent culinary demand across Ernakulam, Kochi, and Thiruvananthapuram drive high farm-gate prices.
            </p>
            <p className="text-xs sm:text-sm leading-relaxed text-slate-700 dark:text-slate-300">
              Growers across Kerala can register for practical{" "}
              <Link
                href="/training"
              ...
              , or consult our agronomy team for customized commercial{" "}
              <Link

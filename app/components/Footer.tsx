...
import { Facebook, Twitter, Instagram, Youtube, Linkedin, Mail, Phone, MapPin, Globe, ArrowRight, ShieldCheck, Share2, Send, HelpCircle } from "lucide-react";

const LOCATIONS = ["Pan India", "Jabalpur MP", "USA", "Australia", "UAE", "Europe"];

const PinterestIcon = ({ size = 18 }: { size?: number }) => <Share2 size={size} />;
const TelegramIcon = ({ size = 18 }: { size?: number }) => <Send size={size} />;
const QuoraIcon = ({ size = 18 }: { size?: number }) => <HelpCircle size={size} />;

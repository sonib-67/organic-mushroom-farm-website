...
export const CompostUnitContent: React.FC = () => {
  return (
        ...
        <article className="max-w-4xl mx-auto px-6">
          <div className="mb-8 md:mb-12">
            ...
            <h1 className="text-3xl md:text-5xl font-black dark:text-white text-slate-900 mb-6 leading-tight tracking-tight">
              The Heart of Button Mushroom Farming: <span className="gradient-text font-black">The Science of a Commercial Compost Unit</span> 🏭
            </h1>
          </div>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none text-slate-600 dark:text-slate-400 leading-relaxed space-y-6">
            <p className="text-xl dark:text-slate-300 text-slate-700 font-medium">
              If you are planning to enter the highly lucrative Button Mushroom market, there is one undeniable truth you must accept early on: <Link href="/services/button-mushroom" className="text-emerald-600 dark:text-emerald-400 hover:underline font-semibold">Button mushrooms</Link> do not grow on plain soil, and they certainly do not grow on raw agricultural waste.
            </p>
            <p>
            ...
            <div className="p-8 md:p-10 rounded-[2rem] border dark:border-emerald-500/20 border-emerald-500/20 text-center mt-12 bg-emerald-500/5">
              <h2 className="text-2xl sm:text-3xl font-black dark:text-white text-slate-900 mb-4">Build Your Infrastructure Right</h2>
              <p className="dark:text-slate-300 text-slate-700 text-base sm:text-lg mb-8 max-w-2xl mx-auto">
                Skip the expensive mistakes. Get precise blueprints and <Link href="/services/turnkey-setup" className="text-emerald-600 dark:text-emerald-400 hover:underline font-semibold">turnkey commercial setups</Link> from <strong className="dark:text-white text-slate-900">Organic Mushrooms Farm</strong> today.
              </p>

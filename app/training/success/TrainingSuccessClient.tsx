...
import { pixelTrackCustom } from '@/lib/utils/pixel';
    ...
    <div className="relative pt-24 pb-32 md:pt-32 lg:pb-0 overflow-hidden min-h-screen selection:bg-green-500/30 flex items-center justify-center">
      <div className="w-full max-w-lg mx-auto px-4 z-10">
        <motion.div
          ...
          className="bg-white/85 dark:bg-black/40 backdrop-blur-lg p-5 md:p-8 rounded-2xl md:rounded-[2rem] border dark:border-green-500/20 border-green-500/30 relative overflow-hidden text-center shadow-2xl"
        >
          ...
          <p className="text-slate-600 dark:text-slate-400 text-sm md:text-base mb-1 font-medium">Thank you for joining our program</p>
          <p className="text-emerald-600 dark:text-emerald-400 text-xs md:text-sm mb-5 font-bold uppercase tracking-wider">{courseOrServiceName}</p>
          ...
          <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-4 md:p-6 mb-5 text-center relative z-10">
            ...
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-[11px] text-green-700 dark:text-green-400 font-bold animate-pulse">Redirecting to WhatsApp chat...</span>
            </div>
            <a href={whatsappUrl}
            ...
            <p className="text-[11px] mt-4 text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
          ...
          <button 
             onClick={() => router.push("/")}
             className="inline-flex items-center justify-center w-full px-4 py-3 md:py-4 bg-slate-100 hover:bg-slate-200 dark:bg-white/5 dark:hover:bg-white/10 border border-slate-200 dark:border-white/10 rounded-xl font-bold text-slate-700 dark:text-slate-300 hover:text-black dark:hover:text-white transition-all text-xs md:text-sm mt-2 relative z-10 cursor-pointer"
          >
            Back to Home
          </button>
        </motion.div>

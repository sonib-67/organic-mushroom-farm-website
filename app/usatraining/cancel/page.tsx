...
export const metadata: Metadata = {
  title: "USA Training Enrollment Cancelled | Organic Mushroom Farm",
  description: "USA training program registration checkout was cancelled.",
  robots: {
    index: false,
    follow: false,
  },
  alternates: {
    canonical: "https://organicmushroomsfarm.com/usatraining/cancel",
  },
};

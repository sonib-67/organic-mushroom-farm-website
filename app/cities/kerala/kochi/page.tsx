...
export const metadata: Metadata = {
  title: "കൊച്ചിയിൽ Mushroom Farming വളരുന്നത് എന്തുകൊണ്ട്? | Kochi Guide 2026",
  description:
    "Kochi Mushroom Farming complete guide. Learn mushroom farm setup, high-yield spawn supply, commercial plans, subsidies & marketing support in Kerala.",
  alternates: {
...
export default function ArticleKochiTrainingPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "കൊച്ചിയുടെ climate ഇതിന് അനുയോജ്യമാണോ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "അതെ, natural humidity വളരെ നല്ലതാണ്. വേനൽക്കാലത്ത് മാത്രം foggers പോലെയുള്ള artificial support വേണ്ടി വരും.",
        },
      },
      {
        "@type": "Question",
        name: "എത്ര space വേണം?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "ഒരു spare room മതിയാകും. സ്ഥലം എന്നതിനേക്കാൾ എത്ര racks വെക്കാം എന്നതാണ് പ്രധാനം.",
        },
      },
      {
        "@type": "Question",
        name: "Beginners-ന് ഏറ്റവും നല്ല variety ഏതാണ്?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oyster mushroom ആണ് ഏറ്റവും എളുപ്പത്തിൽ ചെയ്യാൻ സാധിക്കുന്നത്.",
        },
      },
      {
        "@type": "Question",
        name: "കൃഷിയിൽ മുൻപരിചയം ആവശ്യമുണ്ടോ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "ഇല്ല, homemakers, students, professionals തുടങ്ങി ആർക്കും ഇത് ചെയ്യാവുന്നതാണ്.",
        },
      },
      {
        "@type": "Question",
        name: "Spawning മുതൽ harvest വരെ എത്ര സമയം എടുക്കും?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oyster പോലെയുള്ള varieties ഏതാനും ആഴ്ചകൾക്കുള്ളിൽ വിളവെടുക്കാൻ സാധിക്കും.",
        },
      },
      {
        "@type": "Question",
        name: "Online training ഫലപ്രദമാണോ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Theory പഠിക്കാൻ വളരെ നല്ലതാണ്, എന്നാൽ ഒരു ചെറിയ offline practical session കൂടി ചെയ്യുന്നത് confidence കൂട്ടും.",
        },
      },
      {
        "@type": "Question",
        name: "ഇവ എവിടെ വിൽക്കാം?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Local vegetable markets, organic stores, restaurants, അതുപോലെ online delivery വഴിയും വിൽക്കാം.",
        },
      },
      {
        "@type": "Question",
        name: "Government subsidies ലഭ്യമാണോ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "PMFME അടക്കം പല സ്കീമുകളും നിലവിലുണ്ട്. Agriculture ഡിപ്പാർട്മെന്റുമായി ബന്ധപ്പെടുക.",
        },
      },
      {
        "@type": "Question",
        name: "മറ്റു കൃഷികളുടെ കൂടെ ഇത് ചെയ്യാമോ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "തീർച്ചയായും. കോതമംഗലം പോലെയുള്ള സ്ഥലങ്ങളിൽ കർഷകർ ഇതൊരു complementary income ആയി ചെയ്യുന്നുണ്ട്.",
        },
      },
      {
        "@type": "Question",
        name: "പരാജയപ്പെടാനുള്ള പ്രധാന കാരണം എന്താണ്?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Poor hygiene കാരണമുണ്ടാകുന്ന contamination-ഉം humidity control ഇല്ലാത്തതുമാണ് പ്രധാന കാരണങ്ങൾ.",
        },
      },
      {
        "@type": "Question",
        name: "Dry mushrooms-ന് മാർക്കറ്റ് ഉണ്ടോ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Health-conscious buyers-ന്റെ ഇടയിൽ നല്ല ഡിമാൻഡ് ഉണ്ട്.",
        },
      },
      {
        "@type": "Question",
        name: "സ്ത്രീകൾക്ക് വീട്ടിലിരുന്ന് ചെയ്യാൻ സാധിക്കുമോ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "അതെ, flexible working hours കാരണം സ്ത്രീകൾക്ക് ഏറ്റവും അനുയോജ്യമായ ബിസിനസ്സ് ആണിത്.",
        },
      },
      {
        "@type": "Question",
        name: "ഹോട്ടലുകൾ local mushrooms വാങ്ങാറുണ്ടോ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Freshness-ന് വേണ്ടി മറൈൻ ഡ്രൈവ്, എയർപോർട്ട് ഭാഗത്തെ ഹോട്ടലുകൾ local suppliers-നെയാണ് ആശ്രയിക്കുന്നത്.",
        },
      },
      {
        "@type": "Question",
        name: "Full setup ചെയ്തു തരുന്ന service ഉണ്ടോ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "ഉണ്ട്. Turnkey projects വഴി infrastructure, equipment, staff training ഉൾപ്പെടെ എല്ലാം ചെയ്തു തരുന്നതാണ്.",
        },
      },
    ],
  };
  ...
  const localBusinessSchema = {
    "@type": "LocalBusiness",
    name: "Organic Mushrooms Farm - Kochi & Ernakulam Center",
    description:
      "Mushroom farming training, farm setup, pure lab spawn supply and commercial consultancy services across Kochi, Ernakulam, Kakkanad, Aluva and Kerala.",
    url: "https://organicmushroomsfarm.com/cities/kerala/kochi",
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="glass p-6 md:p-10 lg:p-12 rounded-3xl border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden space-y-6 md:space-y-8">
            ...
            <header className="text-center md:text-left border-b dark:border-white/10 border-black/10 pb-6 md:pb-8">
              <h1 className="text-lg md:text-xl lg:text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-3 md:mb-4 leading-tight">
              ...
              <p className="text-primary-start font-semibold tracking-wider text-xs md:text-sm">
                Organic Mushrooms Farm — Kochi, Ernakulam, Kerala Complete Guide
              </p>
            </header>
            ...
            {/* Section 1 */}
            <section aria-labelledby="why-kochi-heading" className="space-y-3 md:space-y-4">
              <h2
                id="why-kochi-heading"
              ...
              <p className="text-sm md:text-base dark:text-slate-300 text-slate-700 leading-relaxed">
                കേരളത്തിലെ food habits മാറിക്കൊണ്ടിരിക്കുകയാണ് എന്നതും ഒരു പ്രധാന ഘടകമാണ്. Mushroom curry, cutlets, biryani എന്നിവ ഇപ്പോൾ ഫോർട്ട് കൊച്ചി കഫേകളിലും മറ്റും home-kitchen regulars ആയി മാറി. ഈ cultural shift ആണ് farm level-ൽ വലിയൊരു ഡിമാൻഡ് ഉണ്ടാക്കുന്നത്.
              </p>
            </section>

            {/* Section 2 */}
            <section aria-labelledby="demand-heading" className="space-y-3 md:space-y-4">
              <h2
                id="demand-heading"
                className="text-lg md:text-xl lg:text-2xl font-bold dark:text-white text-slate-900 mt-8 mb-4 border-l-4 border-primary-start pl-4"
              >
              ...
              <p className="text-sm md:text-base dark:text-slate-300 text-slate-700 leading-relaxed">
                ഒരു യഥാർത്ഥ വസ്തുത എന്തെന്നാൽ, <Link href="/states/kerala" className="text-primary-start hover:underline font-medium">കേരളത്തിൽ</Link> ഇപ്പോൾ local supply-യേക്കാൾ കൂടുതൽ ഡിമാൻഡ് ഉണ്ട്. എറണാകുളം മാർക്കറ്റുകളിൽ വിൽക്കുന്ന മിക്ക mushrooms-ഉം തമിഴ്നാട്ടിൽ നിന്നോ കർണാടകയിൽ നിന്നോ വരുന്നതാണ്. അതുകൊണ്ട് freshness കുറവായിരിക്കും, വിലയും കൂടുതലാണ്. ചേരാനല്ലൂർ, ഏലൂർ, വരാപ്പുഴ എന്നിവിടങ്ങളിലെ local growers-ന് ഇതൊരു വലിയ opportunity ആണ്.
              </p>
              <p className="text-sm md:text-base dark:text-slate-300 text-slate-700 leading-relaxed">
            ...
            {/* Section 3 */}
            <section aria-labelledby="ernakulam-opportunities-heading" className="space-y-3 md:space-y-4">
              <h2
                id="ernakulam-opportunities-heading"
                className="text-lg md:text-xl lg:text-2xl font-bold dark:text-white text-slate-900 mt-8 mb-4 border-l-4 border-primary-start pl-4"
              >
              ...
              <h3 className="text-base md:text-lg font-bold dark:text-white text-slate-900 mt-6 mb-2">
            ...
            {/* Section 4 */}
            <section aria-labelledby="commercial-setup-heading" className="space-y-3 md:space-y-4">
              <h2
                id="commercial-setup-heading"
                className="text-lg md:text-xl lg:text-2xl font-bold dark:text-white text-slate-900 mt-8 mb-4 border-l-4 border-primary-start pl-4"
              >
              ...
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed mb-3">Project cost നിങ്ങളുടെ scale അനുസരിച്ച് മാറും:</p>
              <ul className="list-disc pl-6 space-y-2 text-xs md:text-sm dark:text-slate-300 text-slate-700">
              ...
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed mt-4 italic">
                Note: കൃത്യമായ investment തീരുമാനിക്കാൻ ഒരു detailed <Link href="/business-plan" className="text-primary-start hover:underline font-medium">mushroom farming project report</Link> തയ്യാറാക്കേണ്ടത് അത്യാവശ്യമാണ്.
              </p>
            </section>

            {/* Section 5 */}
            <section aria-labelledby="training-programs-heading" className="space-y-3 md:space-y-4">
              <h2
              ...
              <ul className="list-disc pl-6 space-y-3 text-xs md:text-sm dark:text-slate-300 text-slate-700">
                <li>
                  <strong>Online Training:</strong> Vyttila, Thevara പോലെയുള്ള സ്ഥലങ്ങളിൽ വീട്ടിലിരുന്ന് പഠിക്കാൻ താല്പര്യമുള്ള സ്ത്രീകൾക്ക് ഇത് വളരെ ഉപകാരപ്രദമാണ്. <Link href="/training" className="text-primary-start hover:underline font-medium">Live interactive classes</Link>, WhatsApp group support, business planning, downloadable PDF notes എന്നിവ ഇതിൽ ഉൾപ്പെടുന്നു.
                </li>
                <li>
                  <strong>Offline Practical Training:</strong> ഫാം നേരിട്ട് സന്ദർശിക്കാനും, spawn production, sterilization, harvesting, packaging എന്നിവ നേരിട്ട് പഠിക്കാനും <Link href="/workshop" className="text-primary-start hover:underline font-medium">offline training</Link> സഹായിക്കുന്നു. Disease &amp; pest management കൃത്യമായി മനസ്സിലാക്കാൻ ഇത് അത്യാവശ്യമാണ്.
                </li>
              </ul>
            </section>

            {/* Section 6 */}
            <section aria-labelledby="spawn-sales-heading" className="space-y-3 md:space-y-4">
              <h2
                id="spawn-sales-heading"
                className="text-lg md:text-xl lg:text-2xl font-bold dark:text-white text-slate-900 mt-8 mb-4 border-l-4 border-primary-start pl-4"
              >
                Spawn Sales, Market Opportunities &amp; Value Addition
              </h2>
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">
                ഗുണനിലവാരമുള്ള <Link href="/spawn-seed" className="text-primary-start hover:underline font-medium">Spawn (വിത്ത്)</Link> ആണ് വിജയത്തിന്റെ അടിസ്ഥാനം. Oyster (Grey, Pink, Phoenix, King), Milky, Button, Shiitake, Reishi, Lion&apos;s Mane തുടങ്ങിയവയുടെ spawn നിലവിൽ ലഭ്യമാണ്.
              </p>
              <ul className="list-disc pl-6 space-y-3 text-xs md:text-sm dark:text-slate-300 text-slate-700">
                <li>
                  <strong>Fresh Mushroom Sales:</strong> Retail organic stores, wholesale distributors, Marine Drive/Fort Kochi ഭാഗത്തെ hotels, supermarkets, പിന്നെ Edappally, Kakkanad ഭാഗങ്ങളിലെ online subscription delivery എന്നിവയാണ് പ്രധാന channels. ഇതിനായി <a href="https://wa.me/919203544140?text=I%20am%20interested%20in%20Fresh%20Mushrooms" target="_blank" rel="noopener noreferrer" className="text-primary-start hover:underline font-medium">Fresh Mushroom</a> sales channels നിങ്ങൾക്ക് ഉപയോഗിക്കാം.
                </li>
                <li>
                  <strong>Dry Mushroom &amp; Value Addition:</strong> Shelf-life കൂട്ടാൻ ഇത് സഹായിക്കും. Mushroom powder, soup mix, medicinal mushroom products എന്നിവയ്ക്ക് കേരളത്തിലും ഗൾഫ് മാർക്കറ്റുകളിലും (export) വലിയ ഡിമാൻഡ് ഉണ്ട്. ഞങ്ങളുടെ <a href="https://wa.me/919203544140?text=I%20am%20interested%20in%20Dry%20Mushrooms" target="_blank" rel="noopener noreferrer" className="text-primary-start hover:underline font-medium">Dry Mushroom</a> service വഴി നിങ്ങൾക്ക് സപ്പോർട്ട് ലഭിക്കുന്നതാണ്.
                </li>
              </ul>
            </section>
            ...
            <section aria-labelledby="business-plan-heading" className="space-y-3 md:space-y-4">
              ...
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed font-semibold">
                കേരളത്തിൽ സർക്കാർ തലത്തിൽ പല <Link href="/subsidy" className="text-primary-start hover:underline font-medium">സബ്സിഡികളും</Link> ലഭ്യമാണ്:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-xs md:text-sm dark:text-slate-300 text-slate-700">
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5 flex items-start gap-2">
                    ...
                    കൊച്ചിയുടെ climate ഇതിന് അനുയോജ്യമാണോ?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    അതെ, natural humidity വളരെ നല്ലതാണ്. വേനൽക്കാലത്ത് മാത്രം foggers പോലെയുള്ള artificial support വേണ്ടി വരും.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  ...
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    ഒരു spare room മതിയാകും. സ്ഥലം എന്നതിനേക്കാൾ എത്ര racks വെക്കാം എന്നതാണ് പ്രധാനം.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5 flex items-start gap-2">
                    <HelpCircle size={16} className="text-primary-start shrink-0 mt-0.5" />
                    Beginners-ന് ഏറ്റവും നല്ല variety ഏതാണ്?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    <Link href="/articles/oyster-mushroom-cultivation-process" className="text-primary-start hover:underline font-medium">Oyster mushroom</Link> ആണ് ഏറ്റവും എളുപ്പത്തിൽ ചെയ്യാൻ സാധിക്കുന്നത്.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5 flex items-start gap-2">
                    <HelpCircle size={16} className="text-primary-start shrink-0 mt-0.5" />
                    കൃഷിയിൽ മുൻപരിചയം ആവശ്യമുണ്ടോ?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    ഇല്ല, homemakers, students, professionals തുടങ്ങി ആർക്കും ഇത് ചെയ്യാവുന്നതാണ്.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5 flex items-start gap-2">
                    <HelpCircle size={16} className="text-primary-start shrink-0 mt-0.5" />
                    Spawning മുതൽ harvest വരെ എത്ര സമയം എടുക്കും?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    Oyster പോലെയുള്ള varieties ഏതാനും ആഴ്ചകൾക്കുള്ളിൽ വിളവെടുക്കാൻ സാധിക്കും.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5 flex items-start gap-2">
                    <HelpCircle size={16} className="text-primary-start shrink-0 mt-0.5" />
                    Online training ഫലപ്രദമാണോ?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    Theory പഠിക്കാൻ വളരെ നല്ലതാണ്, എന്നാൽ ഒരു ചെറിയ offline practical session കൂടി ചെയ്യുന്നത് confidence കൂട്ടും.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  ...
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    Local vegetable markets, organic stores, restaurants, അതുപോലെ online delivery വഴിയും വിൽക്കാം.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5 flex items-start gap-2">
                    <HelpCircle size={16} className="text-primary-start shrink-0 mt-0.5" />
                    Government subsidies ലഭ്യമാണോ?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    PMFME അടക്കം പല സ്കീമുകളും നിലവിലുണ്ട്. Agriculture ഡിപ്പാർട്മെന്റുമായി ബന്ധപ്പെടുക.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5 flex items-start gap-2">
                    <HelpCircle size={16} className="text-primary-start shrink-0 mt-0.5" />
                    മറ്റു കൃഷികളുടെ കൂടെ ഇത് ചെയ്യാമോ?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    തീർച്ചയായും. കോതമംഗലം പോലെയുള്ള സ്ഥലങ്ങളിൽ കർഷകർ ഇതൊരു complementary income ആയി ചെയ്യുന്നുണ്ട്.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5 flex items-start gap-2">
                    <HelpCircle size={16} className="text-primary-start shrink-0 mt-0.5" />
                    പരാജയപ്പെടാനുള്ള പ്രധാന കാരണം എന്താണ്?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    Poor hygiene കാരണമുണ്ടാകുന്ന contamination-ഉം humidity control ഇല്ലാത്തതുമാണ് പ്രധാന കാരണങ്ങൾ.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5 flex items-start gap-2">
                    <HelpCircle size={16} className="text-primary-start shrink-0 mt-0.5" />
                    Dry mushrooms-ന് മാർക്കറ്റ് ഉണ്ടോ?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    Health-conscious buyers-ന്റെ ഇടയിൽ നല്ല ഡിമാൻഡ് ഉണ്ട്.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5 flex items-start gap-2">
                    <HelpCircle size={16} className="text-primary-start shrink-0 mt-0.5" />
                    സ്ത്രീകൾക്ക് വീട്ടിലിരുന്ന് ചെയ്യാൻ സാധിക്കുമോ?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    അതെ, flexible working hours കാരണം സ്ത്രീകൾക്ക് ഏറ്റവും അനുയോജ്യമായ ബിസിനസ്സ് ആണിത്.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5 flex items-start gap-2">
                    <HelpCircle size={16} className="text-primary-start shrink-0 mt-0.5" />
                    ഹോട്ടലുകൾ local mushrooms വാങ്ങാറുണ്ടോ?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    Freshness-ന് വേണ്ടി മറൈൻ ഡ്രൈവ്, എയർപോർട്ട് ഭാഗത്തെ ഹോട്ടലുകൾ local suppliers-നെയാണ് ആശ്രയിക്കുന്നത്.
                  </p>
                </div>
                ...
                <div className="bg-black/5 dark:bg-white/5 p-4 sm:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5 flex items-start gap-2">
                    <HelpCircle size={16} className="text-primary-start shrink-0 mt-0.5" />
                    Full setup ചെയ്തു തരുന്ന service ഉണ്ടോ?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                    ഉണ്ട്. <Link href="/turnkey-projects" className="text-primary-start hover:underline font-medium">Turnkey projects</Link> വഴി infrastructure, equipment, staff training ഉൾപ്പെടെ എല്ലാം ചെയ്തു തരുന്നതാണ്.
                  </p>
                </div>
              </div>
            </section>
            ...
            >
              ...
              >
                Ready to start your mushroom farming journey in Kochi?
              </h2>
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed mb-6">
                നിങ്ങൾക്ക് training, quality spawn, farm setup, അല്ലെങ്കിൽ ഒരു detailed project report ആവശ്യമുണ്ടെങ്കിൽ — ഫോർട്ട് കൊച്ചി മുതൽ അങ്കമാലി വരെയുള്ള ഏത് പ്രദേശത്തായാലും — നിങ്ങളുടെ സ്വന്തം <Link href="/" className="text-primary-start hover:underline font-semibold">organic mushroom farming business</Link> തുടങ്ങാനുള്ള ആദ്യ പടിയായി ഇന്ന് തന്നെ ഞങ്ങളെ കോൺടാക്ട് ചെയ്യുക.
              </p>

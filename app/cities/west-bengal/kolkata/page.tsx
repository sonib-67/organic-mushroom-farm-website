...
export const metadata: Metadata = {
  ...
  description:
    "Start Your Profitable Agribusiness Today! Premium mushroom farming training, spawn supply and commercial setup in Kolkata, West Bengal.",
  alternates: {
...
export default function ArticleKolkataTrainingPage() {
  ...
  const localBusinessSchema = {
    "@type": "LocalBusiness",
    name: "Organic Mushrooms Farm Kolkata",
    description:
      "Commercial mushroom farming training, mushroom farm setup, spawn supply, fresh & dry mushroom distribution, and agribusiness consultancy in Kolkata, West Bengal.",
    url: "https://organicmushroomsfarm.com/cities/west-bengal/kolkata",
  ...
  const courseSchema = {
    "@type": "Course",
    name: "Commercial Mushroom Cultivation Training Kolkata",
    description:
      "Comprehensive commercial mushroom farming training covering spawn management, climate control, substrate preparation, disease management, and marketing in West Bengal.",
    provider: {
      "@type": "Organization",
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="glass p-6 md:p-10 lg:p-12 rounded-3xl border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden space-y-6 md:space-y-8">
            ...
            <section aria-labelledby="why-growing-heading" className="space-y-3 md:space-y-4">
              ...
              <ul className="list-none space-y-2.5 text-xs md:text-sm dark:text-slate-300 text-slate-700">
                <li className="flex gap-2.5 items-start">
                  <CheckCircle2 className="text-primary-start shrink-0 mt-0.5" size={16} />
                  <span><strong>Commercial Cultivation:</strong> Oyster Mushroom (ঝিনুক মাশরুম), Button Mushroom (বোতাম মাশরুম), Milky Mushroom (দুধে মাশরুম)।</span>
                </li>
                <li className="flex gap-2.5 items-start">
                  <CheckCircle2 className="text-primary-start shrink-0 mt-0.5" size={16} />
                  <span><strong>Premium &amp; Medicinal Cultivation:</strong> Shiitake, Lion&apos;s Mane, Reishi (গ্যানোডার্মা), Turkey Tail, এবং অত্যন্ত মূল্যবান Cordyceps Mushroom (কিড়া জড়িবুটি)।</span>
                </li>
              </ul>
            </section>
            ...
            <section aria-labelledby="services-heading" className="space-y-4 md:space-y-6">
              ...
              <div className="space-y-4">
                <div className="dark:bg-white/5 bg-black/5 p-4 md:p-5 rounded-2xl border dark:border-white/10 border-black/10">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5">১. High-Yield Mushroom Spawn Sale</h3>
                  <p className="dark:text-slate-400 text-slate-600 text-xs md:text-sm leading-relaxed">যেকোনো সফল মাশরুম চাষের আসল চাবিকাঠি হলো উন্নত মানের বীজ বা স্পন। আমরা ল্যাব-টেস্টেড, রোগমুক্ত এবং উচ্চ ফলনশীল <strong>Mushroom Spawn Sale</strong> করি। আমাদের কাছে অত্যন্ত সাশ্রয়ী মূল্যে Oyster Mushroom Spawn, Button Mushroom Spawn এবং Milky Mushroom Spawn পেয়ে যাবেন, যা আপনার খামারে সর্বোচ্চ ফলন নিশ্চিত করবে।</p>
                </div>

                <div className="dark:bg-white/5 bg-black/5 p-4 md:p-5 rounded-2xl border dark:border-white/10 border-black/10">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5">২. Smart Mushroom Farm Setup</h3>
                  <p className="dark:text-slate-400 text-slate-600 text-xs md:text-sm leading-relaxed">আপনি কি নিজের বাড়িতে ছোট করে শুরু করতে চান নাকি বড় কমার্শিয়াল প্রজেক্ট করতে চান? আমরা সমস্ত স্কেলের জন্য <Link href="/services" className="text-primary-start hover:underline">Mushroom Farm Setup</Link> করে থাকি। মাশরুমের ভালো ফলনের জন্য সঠিক ক্রমবর্ধমান ঘর (Growing Room), তাপমাত্রা নিয়ন্ত্রণ (Temperature Control), আর্দ্রতা বজায় রাখা (Humidity Management), এবং সঠিক বায়ু চলাচলের (Air Circulation) ব্যবস্থা আমরা বৈজ্ঞানিক পদ্ধতিতে সেটআপ করে দিই।</p>
                </div>

                <div className="dark:bg-white/5 bg-black/5 p-4 md:p-5 rounded-2xl border dark:border-white/10 border-black/10">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5">৩. Online Mushroom Training (বাড়িতে বসেই শিখুন)</h3>
                  <p className="dark:text-slate-400 text-slate-600 text-xs md:text-sm leading-relaxed">দূরত্ব বা সময়ের অভাব এখন আর বাধা নয়। আমাদের <Link href="/training" className="text-primary-start hover:underline">Online Mushroom Training</Link> প্রোগ্রামের মাধ্যমে আপনি ঘরে বসেই মাশরুম চাষের খুঁটিনাটি শিখতে পারবেন। এই Courses সাবস্ট্রেট তৈরি (Substrate Preparation), স্পন রানিং, ক্রপ ম্যানেজমেন্ট, হার্ভেস্টিং এবং প্যাকেজিংয়ের লাইভ ও রেকর্ডেড সেশন করানো হয়।</p>
                </div>

                <div className="dark:bg-white/5 bg-black/5 p-4 md:p-5 rounded-2xl border dark:border-white/10 border-black/10">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5">৪. Practical Offline Mushroom Training</h3>
                  <p className="dark:text-slate-400 text-slate-600 text-xs md:text-sm leading-relaxed">যারা সরাসরি প্র্যাক্টিক্যাল দেখে কাজ শিখতে ভালোবাসেন, তাদের জন্য রয়েছে আমাদের <strong>Offline Mushroom Training</strong>। এখানে আপনি সরাসরি হ্যান্ডস-অন এক্সপেরিয়েন্স পাবেন। বেড তৈরি, লাইভ ডেমোনেস্ট্রেশন, রোগ বা পোকার আক্রমণ দমন (Disease Management) এবং কমার্শিয়াল প্রোডাকশন টেকনিক আমাদের এক্সপার্টরা সামনাসামনি শেখাবেন।</p>
                </div>

                <div className="dark:bg-white/5 bg-black/5 p-4 md:p-5 rounded-2xl border dark:border-white/10 border-black/10">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5">৫. Custom Business Plan &amp; ROI Analysis</h3>
                  <p className="dark:text-slate-400 text-slate-600 text-xs md:text-sm leading-relaxed">যেকোনো ব্যবসায় নামার আগে হিসাব-নিকাশ জরুরি। আমরা আপনাকে একটি প্রফেশনাল <strong>Business Plan &amp; ROI</strong> রিপোর্ট তৈরি করে দিই। আপনার প্রাথমিক বিনিয়োগ (Initial Investment), রানিং খরচ (Operating Costs) এবং প্রতি মাসে কত টাকা নেট প্রফিট বা রিটার্ন অন ইনভেস্টমেন্ট (ROI) আসবে, তার নিখুঁত ব্লু-প্রিন্ট পেয়ে যাবেন।</p>
                </div>

                <div className="dark:bg-white/5 bg-black/5 p-4 md:p-5 rounded-2xl border dark:border-white/10 border-black/10">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5">৬. Government Subsidy Guidance</h3>
                  <p className="dark:text-slate-400 text-slate-600 text-xs md:text-sm leading-relaxed">ভারত ও পশ্চিমবঙ্গ সরকার কৃষকদের উৎসাহিত করতে মাশরুম চাষে দারুণ ভরতুকি দিয়ে থাকে। NHB (National Horticulture Board) বা অন্যান্য সরকারি প্রকল্পের অধীনে কীভাবে আপনি <Link href="/contact" className="text-primary-start hover:underline">Government Subsidy</Link> পেতে পারেন, তার সঠিক লোন প্রসেস ও ডকুমেন্টেশনের গাইডেন্স আমরা প্রদান করি।</p>
                </div>

                <div className="dark:bg-white/5 bg-black/5 p-4 md:p-5 rounded-2xl border dark:border-white/10 border-black/10">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5">৭. Comprehensive Mushroom Consultancy</h3>
                  <p className="dark:text-slate-400 text-slate-600 text-xs md:text-sm leading-relaxed">খামার তৈরি করার পর অনেক সময় চাষিরা ছোটখাটো সমস্যায় পড়েন (যেমন- ছত্রাকের আক্রমণ বা কম ফলন)। আমাদের <strong>Mushroom Consultancy</strong> সার্ভিসের মাধ্যমে আপনি অভিজ্ঞ কনসালট্যান্টদের সরাসরি টেকনিক্যাল গাইডেন্স এবং ফার্ম ম্যানেজমেন্ট সাপোর্ট পাবেন।</p>
                </div>

                <div className="dark:bg-white/5 bg-black/5 p-4 md:p-5 rounded-2xl border dark:border-white/10 border-black/10">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5">৮. Commercial Turnkey Projects</h3>
                  <p className="dark:text-slate-400 text-slate-600 text-xs md:text-sm leading-relaxed">যদি আপনি বড় স্কেলে বা ইন্ডাস্ট্রিয়াল লেভেলে অটোমেটেড মাশরুম প্ল্যান্ট তৈরি করতে চান, তবে আমাদের <Link href="/articles/turnkey-commercial-setup" className="text-primary-start hover:underline">Turnkey Projects</Link> সার্ভিস আপনার জন্য সেরা অপশন। ইনফ্রাস্ট্রাকচার প্ল্যানিং থেকে শুরু করে ল্যাব সেটআপ এবং সম্পূর্ণ প্রোডাকশন ইউনিট চালু করে দেওয়ার দায়িত্ব আমাদের।</p>
                </div>

                <div className="dark:bg-white/5 bg-black/5 p-4 md:p-5 rounded-2xl border dark:border-white/10 border-black/10">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5">৯. Fresh Mushroom Sale &amp; B2B Supply</h3>
                  <p className="dark:text-slate-400 text-slate-600 text-xs md:text-sm leading-relaxed">আমরা স্থানীয় বাজার, পাইকারি সবজি মান্ডি, রেস্তোরাঁ ও সুপারশপগুলির সাথে সরাসরি যুক্ত। আপনি আমাদের মাধ্যমে হাই-কোয়ালিটি <strong>Fresh Mushroom Sale</strong> করতে পারেন অথবা আপনার উৎপাদিত ফ্রেশ মাশরুম সরাসরি আমাদের বিটুবি (B2B) নেটওয়ার্কে সাপ্লাই করতে পারেন।</p>
                </div>

                <div className="dark:bg-white/5 bg-black/5 p-4 md:p-5 rounded-2xl border dark:border-white/10 border-black/10">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5">১০. High-Profit Dry Mushroom Sale</h3>
                  <p className="dark:text-slate-400 text-slate-600 text-xs md:text-sm leading-relaxed">ফ্রেশ মাশরুমের সেলফ-লাইফ কম হওয়ায় অনেকেই ড্রাই মাশরুমের ব্যবসা পছন্দ করেন। <strong>Dry Mushroom Sale</strong> ব্যবসার সুবিধা হলো এর দীর্ঘস্থায়িত্ব, সহজ পরিবহন এবং প্রিমিয়াম প্রাইসিং। আমরা মাশরুম ড্রাইং প্রসেস এবং ড্রাই মাশরুম ও মাশরুম পাউডার মার্কেটিংয়ে সাহায্য করি।</p>
                </div>

                <div className="dark:bg-white/5 bg-black/5 p-4 md:p-5 rounded-2xl border dark:border-white/10 border-black/10">
                  <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mb-1.5">১১. Dedicated Mushroom Marketing Support</h3>
                  <p className="dark:text-slate-400 text-slate-600 text-xs md:text-sm leading-relaxed">চাষ তো করলেন, কিন্তু বিক্রি করবেন কোথায়? এই চিন্তা দূর করতে আমরা দিচ্ছি <strong>Mushroom Marketing Support</strong>। লোকাল মার্কেট লিংকেজ তৈরি, রিটেল ডিস্ট্রিবিউশন নেটওয়ার্ক, হোটেল-রেস্তোরাঁ চেইনের সাথে টাই-আপ এবং ডিজিটাল ব্র্যান্ডিংয়ের মাধ্যমে আপনার প্রোডাক্ট সরাসরি সঠিক কাস্টমারের কাছে পৌঁছে দেওয়ার রাস্তা আমরা তৈরি করি।</p>
                </div>
              </div>
            </section>
            ...
            <section aria-labelledby="areas-heading" className="space-y-4 md:space-y-6">
              ...
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">
                For more details, visit our <Link href="/training" className="text-primary-start hover:underline">Training section</Link>.
              </p>

              <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mt-4 mb-2">
                Major Urban Areas (কলকাতা ও পার্শ্ববর্তী শহর):
              </h3>
              <ul className="list-none space-y-3 text-xs md:text-sm dark:text-slate-300 text-slate-700">
                <li className="flex gap-2.5 items-start">
                  <MapPin className="text-primary-start shrink-0 mt-0.5" size={16} />
                  <span><strong>Kolkata Central &amp; North:</strong> Dum Dum (দমদম), Shyambazar, Airport Area, Belgharia, Sodepur (সোদপুর), Khardah, Madhyamgram (মধ্যমগ্রাম), Barasat (বারাসাত), Barrackpore.</span>
                </li>
                <li className="flex gap-2.5 items-start">
                  <MapPin className="text-primary-start shrink-0 mt-0.5" size={16} />
                  <span><strong>Kolkata East &amp; South:</strong> Salt Lake (সল্টলেক), New Town (নিউ টাউন), Rajarhat (রাজারহাট), Garia, Jadavpur, Tollygunge, Behala.</span>
                </li>
                <li className="flex gap-2.5 items-start">
                  <MapPin className="text-primary-start shrink-0 mt-0.5" size={16} />
                  <span><strong>Howrah &amp; Hooghly Belt:</strong> Howrah (হাওড়া), Bally (বালি), Liluah, Uttarpara, Dankuni, Shrirampur.</span>
                </li>
              </ul>

              <h3 className="text-sm md:text-base font-bold dark:text-white text-slate-900 mt-6 mb-2">
                Nearby Rural &amp; Village Clusters (আশেপাশের গ্রামাঞ্চল):
              </h3>
              <p className="dark:text-slate-400 text-slate-600 text-xs md:text-sm">
                আমরা গ্রামীণ এলাকার স্বনির্ভর গোষ্ঠী ও কৃষকদের বিশেষভাবে সহায়তা করছি:
              </p>
              <ul className="list-none space-y-3 text-xs md:text-sm dark:text-slate-300 text-slate-700">
                <li className="flex gap-2.5 items-start">
                  <MapPin className="text-primary-start shrink-0 mt-0.5" size={16} />
                  <span><strong>Rajarhat &amp; Bhangar Region:</strong> Lauhati, Chinar Park outskirts, Bhangar Block I &amp; II, Ghatakpukur, Beonta.</span>
                </li>
                <li className="flex gap-2.5 items-start">
                  <MapPin className="text-primary-start shrink-0 mt-0.5" size={16} />
                  <span><strong>Haroa &amp; Minakhan Belt:</strong> Haroa Region, Gopalpur, Kulti, Minakhan villages.</span>
                </li>
                <li className="flex gap-2.5 items-start">
                  <MapPin className="text-primary-start shrink-0 mt-0.5" size={16} />
                  <span><strong>Barasat &amp; Basirhat Region:</strong> Duttapukur, Deganga, Amdanga, Baduria, Basirhat Region (বসিরহাট ও সংলগ্ন গ্রামসমূহ), Swarupnagar, Harishpur.</span>
                </li>
                <li className="flex gap-2.5 items-start">
                  <MapPin className="text-primary-start shrink-0 mt-0.5" size={16} />
                  <span><strong>Howrah Rural:</strong> Amta, Bagnan, Udaynarayanpur, Jagatballavpur.</span>
                </li>
              </ul>
            </section>
            ...
            <section
              ...
              className="bg-linear-to-r from-purple-500/10 to-blue-500/10 p-6 md:p-8 rounded-3xl mt-6 md:mt-8 border border-purple-500/20"
            >
              <h2

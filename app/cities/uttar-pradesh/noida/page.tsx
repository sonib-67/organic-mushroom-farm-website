...
import { Home, ChevronRight, Phone, ArrowRight, MapPin } from "lucide-react";
...
export default function ArticleNoidaTrainingPage() {
  const jsonLdItems = [];
  const jsonLd = {
      ...
      <div className="min-h-screen pt-4 sm:pt-6 pb-20 relative overflow-hidden bg-transparent dark:bg-transparent">
        ...
        <article className="max-w-4xl mx-auto px-4 prose prose-invert">
          <div className="glass p-8 md:p-12 rounded-[3.5rem] border dark:border-white/5 border-black/5 space-y-8">
            ...
            <h2 className="text-xl md:text-xl md:text-2xl font-bold dark:text-white text-slate-900 mt-8 mb-4">
              Mushroom Farming Training in Noida and Nearby Areas
            </h2>

            <p className="dark:text-slate-300 text-slate-700 leading-relaxed font-medium">
              नोएडा, ग्रेटर नोएडा, सेक्टर 62, सेक्टर 18, नोएडा एक्सटेंशन, सेक्टर
              137, सेक्टर 75, सेक्टर 150 और आसपास के गांवों में{" "}
              <Link href="/" className="text-primary-start hover:underline">
                Mushroom Farming
              </Link>{" "}
              तेजी से लोकप्रिय हो रही है। बढ़ती आबादी, हेल्दी फूड की मांग,
              ऑर्गेनिक प्रोडक्ट्स की लोकप्रियता और नए एग्री-बिजनेस अवसरों के
              कारण कई किसान, छात्र, नौकरीपेशा लोग और स्टार्टअप फाउंडर्स मशरूम
              खेती की ओर आकर्षित हो रहे हैं।
            </p>

            <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
              Noida is one of India's fastest-growing urban regions and provides
            ...
            <p className="dark:text-slate-300 text-slate-700 leading-relaxed mt-4">
              Consumers are becoming more health conscious, creating new
            ...
            <div className="space-y-6 mt-6">
              <div>
                ...
                <p className="dark:text-slate-400 text-slate-600">
                  One of the most beginner-friendly mushroom varieties.{" "}
                  <Link
              ...
              <div>
                ...
                <p className="dark:text-slate-400 text-slate-600">
                  Highly popular among households, restaurants and retailers.{" "}
                  <Link
                    href="/services/button-mushroom"
                    className="text-primary-start hover:underline"
                  >
                    Explore Button mushroom cultivation
                  </Link>
                  .
                </p>
              </div>
              <div>
                ...
                <p className="dark:text-slate-400 text-slate-600">
                  Suitable for commercial production in many regions.{" "}
                  <Link
                    href="/services/milky-mushroom"
                    className="text-primary-start hover:underline"
                  >
                    Find out about Milky mushrooms
                  </Link>
                  .
                </p>
              </div>
              <div>
                ...
                <p className="dark:text-slate-400 text-slate-600">
                  Premium gourmet mushroom with growing demand.
                </p>
              </div>
              <div>
                <h3 className="text-lg md:text-xl font-bold dark:text-white text-slate-900 mb-2">
                  Lion's Mane Mushroom Farming
                </h3>
                <p className="dark:text-slate-400 text-slate-600">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-bold dark:text-white text-slate-900 mb-2">
                  Reishi Mushroom Farming
                </h3>
                <p className="dark:text-slate-400 text-slate-600">
                  Widely recognized medicinal mushroom.
                </p>
              </div>
              <div>
                <h3 className="text-lg md:text-xl font-bold dark:text-white text-slate-900 mb-2">
                ...
                <p className="dark:text-slate-400 text-slate-600">
                  Emerging medicinal mushroom category.
                </p>
              </div>
              <div>
                <h3 className="text-lg md:text-xl font-bold dark:text-white text-slate-900 mb-2">
                ...
                <p className="dark:text-slate-400 text-slate-600">
                  High-value medicinal mushroom segment.
                </p>
              </div>
            </div>
            ...
            <p className="dark:text-slate-300 text-slate-700 leading-relaxed mt-4">
              Many successful growers start with a small setup and gradually
              expand production.
            </p>
            ...
            <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
              घर बैठे मशरूम खेती सीखने के लिए{" "}
              <Link
            ...
            <p className="dark:text-slate-300 text-slate-700 leading-relaxed mt-4">
              Students and professionals from Noida and Greater Noida can learn
              from anywhere.
            </p>
            ...
            <p className="dark:text-slate-300 text-slate-700 leading-relaxed mt-4">
              Noida's rapidly growing food industry creates strong market
              demand.
            </p>
            ...
            <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
              Depending on available schemes and eligibility requirements,
              farmers and entrepreneurs may benefit from agriculture and
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-6">
              <div>
                ...
                <ul className="list-none space-y-2 dark:text-slate-400 text-slate-600">
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" /> Sector
                    18
                  </li>
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" /> Sector
                  ...
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" /> Noida
                    Extension
                  </li>
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" /> Pari
                    Chowk
                  </li>
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" />{" "}
                    Knowledge Park
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="list-none space-y-2 dark:text-slate-400 text-slate-600">
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" /> Greater
                    Noida
                  </li>
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" /> Dadri
                  </li>
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" />{" "}
                    Ghaziabad
                  ...
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" /> Jewar
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="list-none space-y-2 dark:text-slate-400 text-slate-600">
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" /> Bisrakh
                    Region
                  </li>
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" /> Shahberi
                    Region
                  </li>
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" /> Dankaur
                    Region
                  </li>
                  <li className="flex gap-2 items-center">
                    <MapPin size={14} className="text-primary-start" /> Rabupura
                    Region
                  </li>
                </ul>
              </div>
            ...
            <p className="dark:text-slate-300 text-slate-700 leading-relaxed mt-4">
              These factors create opportunities for Fresh Mushroom Sale, Dry
              Mushroom Sale and Medicinal Mushroom Businesses.
            </p>
            ...
            <div className="bg-linear-to-r from-primary-start/20 to-primary-end/20 p-8 rounded-3xl mt-12 border border-primary-start/20">
              ...
              <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
                नोएडा और आसपास के क्षेत्रों में Mushroom Farming तेजी से बढ़ता
                हुआ एग्री-बिजनेस अवसर है। सही प्रशिक्षण, गुणवत्तापूर्ण{" "}
                <Link
                  href="/services/spawn-supply"
                  className="text-primary-start hover:underline"
                >
                ...
                , उचित Farm Setup, Marketing Support और{" "}
                <Link
                  href="/blog/mushroom-farming-business-plan-india"
                  className="text-primary-start hover:underline"
                >
                ...
                के माध्यम से किसान, छात्र और उद्यमी सफल Mushroom Business
                स्थापित कर सकते हैं।
              </p>
              <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-6">
                Whether your goal is Mushroom Farm Setup, Online Mushroom
                Training, Offline Mushroom Training, Mushroom Spawn Sale, Fresh
                Mushroom Sale, Dry Mushroom Sale, Mushroom Consultancy, Turnkey
                Projects, Business Plan & ROI, Government Subsidy or Mushroom
                Marketing Support, Noida offers excellent opportunities for

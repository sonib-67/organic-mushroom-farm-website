...
export const metadata: Metadata = {
  ...
  description:
    "Patna Mushroom Farming complete guide. Learn mushroom farm setup, high-yield spawn supply, commercial plans, subsidies & marketing support in Bihar.",
  alternates: {
...
export default function ArticlePatnaTrainingPage() {
  ...
  const localBusinessSchema = {
    "@type": "LocalBusiness",
    name: "Organic Mushrooms Farm Patna",
    description:
      "Commercial mushroom farming training, mushroom farm setup, high-yield spawn supply, fresh & dry mushroom distribution, government subsidies, and agribusiness consultancy in Patna, Bihar.",
    url: "https://organicmushroomsfarm.com/cities/bihar/patna",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "क्या पटना की भीषण गर्मी में मशरूम उगाया जा सकता है?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "बिल्कुल! गर्मी के मौसम के लिए 'मिल्की मशरूम' और 'पैरा मशरूम' सबसे अच्छे होते हैं। इसके अलावा हमारे एडवांस Mushroom Farm Setup (AC और फॉगर सिस्टम) के जरिए आप साल के 365 दिन बटन और ऑयस्टर मशरूम भी आसानी से उगा सकते हैं।",
        },
      },
      {
        "@type": "Question",
        name: "मुझे बिहार में मशरूम की खेती के लिए सरकारी सब्सिडी (अनुदान) कैसे मिलेगी?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "बिहार बागवानी मिशन के तहत मशरूम झोपड़ी और कमर्शियल यूनिट्स पर 50% तक Government Subsidy मिलती है। हमारी टीम आपको बैंक लोन और सब्सिडी के लिए जरूरी कागजात व प्रोजेक्ट रिपोर्ट (DPR) तैयार करने में पूरी गाइडेंस देती है।",
        },
      },
      {
        "@type": "Question",
        name: "मशरूम का बीज (Spawn) पटना में कितने दिन में डिलीवर हो जाता है?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "हम Mushroom Spawn Sale के तहत ऑर्डर मिलने के 24 से 48 घंटे के भीतर पटना और आसपास के जिलों (हाजीपुर, बिहटा, मसौढ़ी) में फ्रेश और लैब-टेस्टेड स्पॉन डिलीवर कर देते हैं।",
        },
      },
      {
        "@type": "Question",
        name: "क्या माल बेचने में Organic Mushrooms Farm मदद करेगा?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "हाँ! हमारा Mushroom Marketing Support आपको पटना की लोकल मंडियों, बड़े होटल्स, और रिटेल चेन्स से डायरेक्ट जोड़ता है, ताकि आपका फ्रेश या ड्राई मशरूम कभी बर्बाद न हो।",
        },
      },
    ],
  };
  ...
  const courseSchema = {
    "@type": "Course",
    name: "Commercial Mushroom Cultivation Guide in Bihar - Patna Training",
    description:
      "Comprehensive commercial mushroom training course covering substrate preparation, spawn management, climate control, harvesting, subsidies, and marketing in Patna, Bihar.",
    provider: {
      "@type": "Organization",
          ...
          <div className="glass p-6 md:p-10 lg:p-12 rounded-3xl border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden space-y-6 md:space-y-8">
            ...
            <section aria-labelledby="intro-heading" className="space-y-3 md:space-y-4">
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed font-medium">
                &ldquo;का हाल बा पटना?&rdquo; गंगा किनारे बसे अपने पटना में अब सिर्फ पारंपरिक खेती नहीं, बल्कि स्मार्ट फार्मिंग का दौर आ गया है। लिट्टी-चोखा के शहर में अब लोग फिटनेस और हेल्दी डाइट को लेकर काफी जागरूक हो गए हैं, जिससे पटना के होटल्स, रेस्टोरेंट्स और सुपरमार्केट्स में मशरूम की डिमांड कई गुना बढ़ गई है।
              </p>
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed font-medium">
                चाहे आप कंकड़बाग के स्टूडेंट हों, बोरिंग रोड के युवा उद्यमी हों या दानापुर और बिहटा के किसान भाई—<strong>Mushroom Farming in Patna</strong> कम जगह और कम लागत में शानदार मुनाफा देने वाला सबसे जबरदस्त एग्री-स्टार्टअप बन चुका है। लेकिन किसी भी नए किसान का सबसे बड़ा सवाल होता है: &ldquo;बढ़िया क्वालिटी का मशरूम बीज (Spawn) कहाँ मिलेगा?&rdquo;
              </p>
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed font-medium">
                यहीं पर <Link href="/" className="text-primary-start hover:underline font-semibold">Organic Mushrooms Farm</Link> आपके लिए एक &apos;वन-स्टॉप सॉल्यूशन&apos; लेकर आया है, जहाँ आपको ट्रेनिंग से लेकर माल बेचने तक की पूरी सुविधा मिलती है।
              </p>
            </section>

            <hr className="my-6 border-t dark:border-white/10 border-black/10" />

            {/* Step 1: Quality Mushroom Spawn Sale */}
            <section aria-labelledby="spawn-heading" className="space-y-3 md:space-y-4">
              <h3
                id="spawn-heading"
                className="text-base md:text-lg lg:text-xl font-bold dark:text-white text-slate-900 flex items-center gap-2"
              >
              ...
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed pl-6">
                मशरूम की खेती में आपकी 90% सफलता इस बात पर निर्भर करती है कि आपका बीज कैसा है। खराब स्पॉन मतलब पूरी फसल बर्बाद! हम पूरी तरह से लैब-टेस्टेड, फर्स्ट-जेनरेशन और फंगस-फ्री <Link href="/spawn-seed" className="text-primary-start hover:underline font-medium">Mushroom Spawn Sale</Link> करते हैं। हमारे पास बिहार के मौसम के अनुकूल निम्नलिखित सभी वेरायटीज के फ्रेश स्पॉन होलसेल और रिटेल रेट पर उपलब्ध हैं:
              </p>
              <div className="pl-6 mt-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 rounded-2xl border dark:border-white/5 border-black/5 bg-black/5 dark:bg-white/5">
                  <h4 className="text-xs md:text-sm font-bold dark:text-white text-slate-900 mb-2">डेली डिमांड वेरायटी</h4>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <Link href="/articles/oyster-mushroom-cultivation-process" className="text-primary-start hover:underline">Oyster Mushroom (ऑयस्टर)</Link>,{" "}
                    Milky Mushroom (मिल्की), Paddy Straw Mushroom (पैरा मशरूम).
                  </p>
                </div>
                <div className="p-4 rounded-2xl border dark:border-white/5 border-black/5 bg-black/5 dark:bg-white/5">
                  <h4 className="text-xs md:text-sm font-bold dark:text-white text-slate-900 mb-2">प्रीमियम व औषधीय (Medicinal) वेरायटी</h4>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">Shiitake Mushroom, Lion&apos;s Mane Mushroom, Reishi Mushroom, Cordyceps Militaris, Turkey Tail Mushroom, Gucchi Mushroom.</p>
                </div>
              </div>
            </section>
            ...
            {/* Step 2: Training */}
            <section aria-labelledby="training-heading" className="space-y-3 md:space-y-4">
              <h3
                id="training-heading"
                className="text-base md:text-lg lg:text-xl font-bold dark:text-white text-slate-900 flex items-center gap-2"
              >
            ...
            <section aria-labelledby="infrastructure-heading" className="space-y-3 md:space-y-4">
              ...
              <ul className="list-disc pl-11 space-y-2 text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">
                <li><strong>Mushroom Farm Setup:</strong> आपके पास एक छोटा कमरा हो या फूस का छप्पर, हमारी टीम आपके बजट के हिसाब से टेम्परेचर और ह्यूमिडिटी कंट्रोल (नमी नियंत्रण) वाला शानदार <Link href="/services" className="text-primary-start hover:underline font-medium">फार्म सेटअप डिजाइन</Link> करके देती है।</li>
                <li><strong>Commercial Turnkey Projects:</strong> यदि आप बड़े स्तर पर एसी (AC) वाला कमर्शियल ऑटोमेटेड प्लांट लगाना चाहते हैं, तो हमारी टीम जमीन के सर्वे से लेकर मशीनरी इंस्टॉलेशन तक का पूरा <Link href="/turnkey-projects" className="text-primary-start hover:underline font-medium">टर्नकी प्रोजेक्ट</Link> खुद हैंडल करती है।</li>
            ...
            {/* Step 4: Business Planning & Government Subsidies */}
            <section aria-labelledby="planning-heading" className="space-y-3 md:space-y-4">
              ...
              <ul className="list-disc pl-11 space-y-2 text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">
                <li><strong>Business Plan &amp; ROI:</strong> पैसा लगाने से पहले हम आपको एक प्रॉपर <Link href="/business-plan" className="text-primary-start hover:underline font-medium">प्रोजेक्ट रिपोर्ट और ROI</Link> (Return on Investment) शीट बनाकर देते हैं, ताकि आपको पता रहे कि आपका लगाया हुआ पैसा कितने महीनों में वापस आएगा।</li>
                <li><strong>Government Subsidy Guidance:</strong> बिहार सरकार (कृषि विभाग) मशरूम की खेती और झोपड़ी निर्माण के लिए 50% तक की भारी <Link href="/subsidy" className="text-primary-start hover:underline font-medium">Government Subsidy</Link> और अनुदान देती है। हम आपको सब्सिडी के लिए सही प्रोजेक्ट रिपोर्ट बनाने और विभाग से अप्रूवल लेने में पूरी मदद करते हैं।</li>
              </ul>
            </section>

            <hr className="my-6 border-t dark:border-white/10 border-black/10" />

            {/* Step 5: Marketing & Selling Support */}
            <section aria-labelledby="selling-heading" className="space-y-3 md:space-y-4">
              <h3
                id="selling-heading"
                className="text-base md:text-lg lg:text-xl font-bold dark:text-white text-slate-900 flex items-center gap-2"
              >
            ...
            <section aria-labelledby="areas-heading" className="space-y-4 md:space-y-6">
              ...
              <h3 className="text-xs md:text-sm font-bold dark:text-white text-slate-900 mt-4 mb-1">
                मुख्य शहरी क्षेत्र (Patna Urban Hubs):
              </h3>
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">
              ...
              <h3 className="text-xs md:text-sm font-bold dark:text-white text-slate-900 mt-4 mb-1">
                आसपास के प्रमुख शहर और कस्बे (Nearby Satellite Towns):
              </h3>
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">
              ...
              <h3 className="text-xs md:text-sm font-bold dark:text-white text-slate-900 mt-4 mb-1">
                पटना के प्रमुख ग्रामीण व कृषि बेल्ट (Targeted Villages &amp; Rural Belts):
              </h3>
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">
              ...
              <div className="space-y-4">
                <div className="bg-black/5 dark:bg-white/5 p-4 md:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-xs md:text-sm font-bold dark:text-white text-slate-900 mb-1.5">
                    Q1. क्या पटना की भीषण गर्मी में मशरूम उगाया जा सकता है?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">
                    उत्तर: बिल्कुल! गर्मी के मौसम के लिए &apos;मिल्की मशरूम&apos; और &apos;पैरा मशरूम&apos; सबसे अच्छे होते हैं। इसके अलावा हमारे एडवांस Mushroom Farm Setup (AC और फॉगर सिस्टम) के जरिए आप साल के 365 दिन बटन और ऑयस्टर मशरूम भी आसानी से उगा सकते हैं।
                  </p>
                </div>
                <div className="bg-black/5 dark:bg-white/5 p-4 md:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-xs md:text-sm font-bold dark:text-white text-slate-900 mb-1.5">
                    Q2. मुझे बिहार में मशरूम की खेती के लिए सरकारी सब्सिडी (अनुदान) कैसे मिलेगी?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">
                    उत्तर: बिहार बागवानी मिशन के तहत मशरूम झोपड़ी और कमर्शियल यूनिट्स पर 50% तक <Link href="/subsidy" className="text-primary-start hover:underline">Government Subsidy</Link> मिलती है। हमारी टीम आपको बैंक लोन और सब्सिडी के लिए जरूरी कागजात व प्रोजेक्ट रिपोर्ट (DPR) तैयार करने में पूरी गाइडेंस देती है।
                  </p>
                </div>
                <div className="bg-black/5 dark:bg-white/5 p-4 md:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-xs md:text-sm font-bold dark:text-white text-slate-900 mb-1.5">
                    Q3. मशरूम का बीज (Spawn) पटना में कितने दिन में डिलीवर हो जाता है?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">
                    उत्तर: हम Mushroom Spawn Sale के तहत ऑर्डर मिलने के 24 से 48 घंटे के भीतर पटना और आसपास के जिलों (हाजीपुर, बिहटा, मसौढ़ी) में फ्रेश और लैब-टेस्टेड स्पॉन डिलीवर कर देते हैं।
                  </p>
                </div>
                <div className="bg-black/5 dark:bg-white/5 p-4 md:p-5 rounded-2xl border border-black/5 dark:border-white/5">
                  <h3 className="text-xs md:text-sm font-bold dark:text-white text-slate-900 mb-1.5">
                    Q4. क्या माल बेचने में Organic Mushrooms Farm मदद करेगा?
                  </h3>
                  <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed">
                    उत्तर: हाँ! हमारा Mushroom Marketing Support आपको पटना की लोकल मंडियों, बड़े होटल्स, और रिटेल चेन्स से डायरेक्ट जोड़ता है, ताकि आपका फ्रेश या ड्राई मशरूम कभी बर्बाद न हो।
                  </p>
                </div>
              </div>
            </section>
            ...
            >
              ...
              <p className="text-xs md:text-sm dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
                अपनी ट्रेनिंग बुक करने, बेस्ट क्वालिटी का स्पॉन ऑर्डर करने या फ्री कंसल्टेंसी के लिए आज ही हमारी वेबसाइट के <Link href="/contact" className="text-primary-start hover:underline font-semibold">Contact Us पेज</Link> पर जाएं या नीचे कमेंट बॉक्स में अपना नंबर और सवाल लिखें!
              </p>

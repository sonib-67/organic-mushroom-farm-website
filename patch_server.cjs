...
if (!serverTs.includes("nodemailer")) {
  serverTs = "import nodemailer from 'nodemailer';\n" + serverTs;
}

if (!serverTs.includes("api/contact")) {
  const contactRoute = `
// Contact API route
...
`;
  ...
  serverTs = serverTs.replace('async function startServer() {', contactRoute + '\nasync function startServer() {');
}

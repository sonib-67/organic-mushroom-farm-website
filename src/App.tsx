import BlogButtonMushroomFarming from "./legacy-pages/BlogButtonMushroomFarming";
...
import ProcessDetailPage from "./legacy-pages/ProcessDetailPage";
import ModelDetailsPage from "./legacy-pages/ModelDetails";
import CompostUnitSpecsPage from "./legacy-pages/CompostUnitSpecs";
import TrainingCheckoutPage from "./legacy-pages/TrainingCheckoutPage";
import ContactPage from "./legacy-pages/ContactPage";

import EnquiryPage from "./legacy-pages/EnquiryPage";
import SopsPage from "./legacy-pages/Sops";
import ExpertiseDetailsPage from "./legacy-pages/ExpertiseDetails";
import SpawnSeedPage from "./legacy-pages/SpawnSeed";
import BusinessPlan from "./legacy-pages/BusinessPlan";
import MushroomTypes from "./legacy-pages/MushroomTypes";
import MushroomTypeDetails from "./legacy-pages/MushroomTypeDetails";
import EquipmentPageNew from "./legacy-pages/EquipmentPageNew";
import EquipmentInfrastructurePage from "./legacy-pages/EquipmentInfrastructurePage";
import EquipmentGrowingRacksPage from "./legacy-pages/EquipmentGrowingRacksPage";
import EquipmentCompleteListPage from "./legacy-pages/EquipmentCompleteListPage";
import MachineryDirectoryPage from './legacy-pages/equipment-directory/MachineryDirectoryPage';
import EquipmentDirectoryPage from './legacy-pages/equipment-directory/EquipmentDirectoryPage';
import SafetyDirectoryPage from './legacy-pages/equipment-directory/SafetyDirectoryPage';
import InfrastructurePage from './legacy-pages/equipment-directory/InfrastructurePage';
import RawMaterialPage from './legacy-pages/equipment-directory/RawMaterialPage';
import SubstratePrepPage from './legacy-pages/equipment-directory/SubstratePrepPage';
import CompostUnitPage from './legacy-pages/equipment-directory/CompostUnitPage';
import SpawnProductionPage from './legacy-pages/equipment-directory/SpawnProductionPage';
import LaboratoryPage from './legacy-pages/equipment-directory/LaboratoryPage';
import ClimateControlPage from './legacy-pages/equipment-directory/ClimateControlPage';
import VentilationPage from './legacy-pages/equipment-directory/VentilationPage';
import WaterManagementPage from './legacy-pages/equipment-directory/WaterManagementPage';
import HarvestPostHarvestPage from './legacy-pages/equipment-directory/HarvestPostHarvestPage';
import ColdChainPage from './legacy-pages/equipment-directory/ColdChainPage';
import ProcessingPage from './legacy-pages/equipment-directory/ProcessingPage';
import MaterialHandlingPage from './legacy-pages/equipment-directory/MaterialHandlingPage';
import ElectricalPowerPage from './legacy-pages/equipment-directory/ElectricalPowerPage';
import CleaningBiosecurityPage from './legacy-pages/equipment-directory/CleaningBiosecurityPage';
import QualityControlPage from './legacy-pages/equipment-directory/QualityControlPage';
import SafetyAdditionalPage from './legacy-pages/equipment-directory/SafetyAdditionalPage';
import WasteManagementPage from './legacy-pages/equipment-directory/WasteManagementPage';

import BookConsultantPage from "./legacy-pages/BookConsultantPage";
import PaymentSuccessPage from "./legacy-pages/PaymentSuccessPage";
import PaymentCancelledPage from "./legacy-pages/PaymentCancelledPage";
import ROICalculatorPage from "./legacy-pages/ROICalculatorPage";
import Subsidy from "./legacy-pages/Subsidy";
import Blog from "./legacy-pages/Blog";
import ArticlePage from "./legacy-pages/ArticlePage";
import SuccessStories from "./legacy-pages/SuccessStories";
import ProjectSpecsPage from "./legacy-pages/ProjectSpecs";
import ArticleBeginnerGuide from "./legacy-pages/ArticleBeginnerGuide";
import ArticleOysterMushroomCultivation from "./legacy-pages/ArticleOysterMushroomCultivation";
import ArticleMushroomSpawn from "./legacy-pages/ArticleMushroomSpawn";
import ArticleMushroomSpawnSeed from "./legacy-pages/ArticleMushroomSpawnSeed";
import ArticleOysterMushroom from "./legacy-pages/ArticleOysterMushroom";
import ArticleMushroomBusinessPlanIndia from "./legacy-pages/ArticleMushroomBusinessPlanIndia";
import ArticleMilkyMushroom from "./legacy-pages/ArticleMilkyMushroom";
import ArticleTurnkeySetup from "./legacy-pages/ArticleTurnkeySetup";
import ArticleSmartClimateControl from "./legacy-pages/ArticleSmartClimateControl";
import ArticleOperations from "./legacy-pages/ArticleOperations";
import ArticleOysterCultivation from "./legacy-pages/ArticleOysterCultivation";
import ArticleCompostUnit from "./legacy-pages/ArticleCompostUnit";
import ArticleButtonMushroom from "./legacy-pages/ArticleButtonMushroom";
import ArticleSpawnSeeds from "./legacy-pages/ArticleSpawnSeeds";
import ArticleProjectSpecs from "./legacy-pages/ArticleProjectSpecs";
import ArticleSanDiegoMushroomFarming from './legacy-pages/ArticleSanDiegoMushroomFarming';
import HowToStartIndoorMushroomFarmCalifornia from "./legacy-pages/HowToStartIndoorMushroomFarmCalifornia";
import MushroomFarmingUsaGuide from "./legacy-pages/MushroomFarmingUsaGuide";
import ArticleMangaloreKarnataka from "./legacy-pages/ArticleMangaloreKarnataka";
import ArticleOysterMushroomCultivationIndia from "./legacy-pages/ArticleOysterMushroomCultivationIndia";
import ArticleButtonVsOysterMushroom from "./legacy-pages/ArticleButtonVsOysterMushroom";
import ArticleBikanerRajasthan from "./legacy-pages/ArticleBikanerRajasthan";
import ArticleOnlineTraining from "./legacy-pages/ArticleOnlineTraining";
import ArticleOfflineTraining from "./legacy-pages/ArticleOfflineTraining";
import ArticleCitiesIndia from "./legacy-pages/ArticleCitiesIndia";
import ArticleMushroomTrainingGuideEnglish from "./legacy-pages/ArticleMushroomTrainingGuideEnglish";
import ArticleThiruvananthapuramKerala from "./legacy-pages/ArticleThiruvananthapuramKerala";
import ArticleGuwahatiAssam from "./legacy-pages/ArticleGuwahatiAssam";
import ArticleContactForm from "./legacy-pages/ArticleContactForm";
import DisclaimerPage from "./legacy-pages/DisclaimerPage";
import ArticleUdaipurRajasthan from "./legacy-pages/ArticleUdaipurRajasthan";
import ArticleHomeMushroomFarming from "./legacy-pages/ArticleHomeMushroomFarming";
import ArticleMysuruKarnataka from "./legacy-pages/ArticleMysuruKarnataka";
import ArticleSiliguriWestBengal from "./legacy-pages/ArticleSiliguriWestBengal";
import ArticleBusinessPlanHindi from "./legacy-pages/ArticleBusinessPlanHindi";
import ArticleTrainingGuideHindi from "./legacy-pages/ArticleTrainingGuideHindi";
import ArticleMushroomTrainingAffordable from "./legacy-pages/ArticleMushroomTrainingAffordable";
import ArticleGharParMushroomFarming from "./legacy-pages/ArticleGharParMushroomFarming";
import ArticleUltimateGuideHinglish from "./legacy-pages/ArticleUltimateGuideHinglish";
import ArticleUSAProfitGuide from "./legacy-pages/ArticleUSAProfitGuide";
import ArticleUSAMedicinalIncome from "./legacy-pages/ArticleUSAMedicinalIncome";
import ArticleUltimateGuideIndia from "./legacy-pages/ArticleUltimateGuideIndia";
import ArticleTamilTrainingGuide from "./legacy-pages/ArticleTamilTrainingGuide";
import SEO from "./components/SEO";
import ArticlePracticalGuideHinglish from "./legacy-pages/ArticlePracticalGuideHinglish";
import ArticleBusinessPlanIndia from "./legacy-pages/ArticleBusinessPlanIndia";
import ArticleTurnkeyCommercialSetup from "./legacy-pages/ArticleTurnkeyCommercialSetup";
import ArticleMushroomFarmingRussia from "./legacy-pages/ArticleMushroomFarmingRussia";
import ArticleOrganicMushroomFarmGuide from "./legacy-pages/ArticleOrganicMushroomFarmGuide";
import ArticleCommercialSetupTraining from "./legacy-pages/ArticleCommercialSetupTraining";

import OperationsPage from "./legacy-pages/OperationsPage";
...
import SiteVisitConsultationPage from "./legacy-pages/SiteVisitConsultationPage";
...
import MushroomPriceTodayPage from "./legacy-pages/MushroomPriceTodayPage";
import MushroomFranchisePage from "./legacy-pages/MushroomFranchisePage";
import WorkshopPage from "./legacy-pages/WorkshopPage";
import UsaTrainingPage from "./legacy-pages/UsaTrainingPage";
import UsaSuccessBasic from "./legacy-pages/UsaSuccessBasic";
import UsaSuccessAdvanced from "./legacy-pages/UsaSuccessAdvanced";

import MadhyaPradeshPage from "./legacy-pages/MadhyaPradeshPage";
import JabalpurPage from "./legacy-pages/JabalpurPage";
import JabalpurBlogPage from "./legacy-pages/JabalpurBlogPage";
import StatesPage from "./legacy-pages/StatesPage";
import MaharashtraPage from "./legacy-pages/MaharashtraPage";
import KarnatakaPage from "./legacy-pages/KarnatakaPage";
import TamilNaduPage from "./legacy-pages/TamilNaduPage";
import DelhiPage from "./legacy-pages/DelhiPage";
import TelanganaPage from "./legacy-pages/TelanganaPage";
import WestBengalPage from "./legacy-pages/WestBengalPage";
import BiharPage from "./legacy-pages/BiharPage";
import ChandigarhPage from "./legacy-pages/ChandigarhPage";
import ChhattisgarhPage from "./legacy-pages/ChhattisgarhPage";
import KeralaPage from "./legacy-pages/KeralaPage";
import GujaratPage from "./legacy-pages/GujaratPage";
import PunjabPage from "./legacy-pages/PunjabPage";
import RajasthanPage from "./legacy-pages/RajasthanPage";
import UttarPradeshPage from "./legacy-pages/UttarPradeshPage";
import HaryanaPage from "./legacy-pages/HaryanaPage";
import UttarakhandPage from "./legacy-pages/UttarakhandPage";
import AndhraPradeshPage from "./legacy-pages/AndhraPradeshPage";
import OdishaPage from "./legacy-pages/OdishaPage";
import JharkhandPage from "./legacy-pages/JharkhandPage";
import PunePage from "./legacy-pages/PunePage";
import PuneBlogPage from "./legacy-pages/PuneBlogPage";
import AssamPage from "./legacy-pages/AssamPage";
import ClimateTrackerPage from "./legacy-pages/ClimateTrackerPage";
...
import ArticleMadhyaPradeshGuide from './legacy-pages/ArticleMadhyaPradeshGuide';

import ArticleJabalpurGuide from './legacy-pages/ArticleJabalpurGuide';
import ArticleBangaloreTraining from './legacy-pages/ArticleBangaloreTraining';
import ArticleMysuruTraining from './legacy-pages/ArticleMysuruTraining';
import ArticleMangaloreTraining from './legacy-pages/ArticleMangaloreTraining';
import ArticleChennaiTraining from './legacy-pages/ArticleChennaiTraining';
import ArticleCoimbatoreTraining from './legacy-pages/ArticleCoimbatoreTraining';
import ArticleMaduraiTraining from './legacy-pages/ArticleMaduraiTraining';
import ArticleTiruchirappalliTraining from './legacy-pages/ArticleTiruchirappalliTraining';
import ArticleMumbaiTraining from './legacy-pages/ArticleMumbaiTraining';
import ArticleDelhiTraining from './legacy-pages/ArticleDelhiTraining';
import ArticleGurugramTraining from './legacy-pages/ArticleGurugramTraining';
import ArticleFaridabadTraining from './legacy-pages/ArticleFaridabadTraining';
import ArticleNoidaTraining from './legacy-pages/ArticleNoidaTraining';
import ArticleDehradunTraining from './legacy-pages/ArticleDehradunTraining';
import ArticleMushroomFarmingMistakes from './legacy-pages/ArticleMushroomFarmingMistakes';
import ArticleHyderabadTraining from './legacy-pages/ArticleHyderabadTraining';
import ArticleKolkataTraining from './legacy-pages/ArticleKolkataTraining';
import ArticleSiliguriTraining from './legacy-pages/ArticleSiliguriTraining';
import ArticleAhmedabadTraining from './legacy-pages/ArticleAhmedabadTraining';
import ArticleSuratTraining from './legacy-pages/ArticleSuratTraining';
import ArticlePatnaTraining from './legacy-pages/ArticlePatnaTraining';
import ArticleChandigarhTraining from './legacy-pages/ArticleChandigarhTraining';
import ArticleJaipurTraining from './legacy-pages/ArticleJaipurTraining';
import ArticleBikanerTraining from './legacy-pages/ArticleBikanerTraining';
import ArticleUdaipurTraining from './legacy-pages/ArticleUdaipurTraining';
import ArticleLucknowTraining from './legacy-pages/ArticleLucknowTraining';
import ArticleAgraTraining from './legacy-pages/ArticleAgraTraining';
import ArticleKanpurTraining from './legacy-pages/ArticleKanpurTraining';
import ArticleIndoreTraining from './legacy-pages/ArticleIndoreTraining';
import ArticleBhopalTraining from './legacy-pages/ArticleBhopalTraining';
import ArticleGwaliorTraining from './legacy-pages/ArticleGwaliorTraining';
import ArticleNagpurTraining from './legacy-pages/ArticleNagpurTraining';
import ArticleAurangabadTraining from './legacy-pages/ArticleAurangabadTraining';
import ArticleRaipurTraining from './legacy-pages/ArticleRaipurTraining';
import ArticleKochiTraining from './legacy-pages/ArticleKochiTraining';
import ArticleThiruvananthapuramTraining from './legacy-pages/ArticleThiruvananthapuramTraining';
import ArticleVisakhapatnamTraining from './legacy-pages/ArticleVisakhapatnamTraining';
import ArticleVijayawadaTraining from './legacy-pages/ArticleVijayawadaTraining';
import ArticleBhubaneswarTraining from './legacy-pages/ArticleBhubaneswarTraining';
import ArticleRanchiTraining from './legacy-pages/ArticleRanchiTraining';
import ArticleGuwahatiTraining from './legacy-pages/ArticleGuwahatiTraining';
import ArticleNashikTraining from './legacy-pages/ArticleNashikTraining';
import ArticleVadodaraTraining from './legacy-pages/ArticleVadodaraTraining';
import ArticleRajkotTraining from './legacy-pages/ArticleRajkotTraining';
import ArticleAmritsarTraining from './legacy-pages/ArticleAmritsarTraining';

import ArticleTurnkeyMushroomFarm from './legacy-pages/ArticleTurnkeyMushroomFarm';
import ArticleMushroomTrainingGuideHindi from "./legacy-pages/ArticleMushroomTrainingGuideHindi";
import ArticleMushroomTrainingGuide from "./legacy-pages/ArticleMushroomTrainingGuide";
import ArticleMushroomTrainingGuidePunjabi from "./legacy-pages/ArticleMushroomTrainingGuidePunjabi";
import ArticleOrganicMushroomHealthBenefits from "./legacy-pages/ArticleOrganicMushroomHealthBenefits";
import ArticleBestMushroomFarmingTrainingGuide from "./legacy-pages/ArticleBestMushroomFarmingTrainingGuide";
import ArticleHowToGetMushroomFarmingTraining from "./legacy-pages/ArticleHowToGetMushroomFarmingTraining";

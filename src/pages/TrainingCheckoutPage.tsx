...
export default function TrainingCheckoutPage() {
  ...
  const [paymentStatus, setPaymentStatus] = useState<"idle" | "cancelled">(
    "idle",
  );
          ...
          <div className="relative dark:bg-[#0A0A0A]/90 bg-white/95 backdrop-blur-2xl rounded-[2rem] sm:rounded-[2.5rem] p-5 sm:p-8 overflow-hidden h-full">
            ...
            {paymentStatus === "cancelled" ? (
              ...
              >
                ...
                <h2 className="text-xl sm:text-2xl font-black dark:text-white text-slate-900 mb-2 sm:mb-3 tracking-tight">
                  Payment Cancelled
                </h2>
                <p className="dark:text-slate-400 text-slate-500 text-xs sm:text-sm mb-6 sm:mb-8 font-medium">
                  Your premium training enrollment was not completed.
                </p>
                <button
                  onClick={() => {
                    setPaymentStatus("idle");
              ...
              <>
                <div className="text-center mb-6 sm:mb-8">
                  <div className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-full dark:bg-white/5 bg-black/5 dark:border-white/10 border-black/5 border mb-3 sm:mb-4">
                    ...
                    <span className="text-[9px] font-bold uppercase tracking-widest dark:text-slate-300 text-slate-700">
                      Access
                    </span>
                  </div>
                  <h1 className="text-xl sm:text-2xl font-black dark:text-white text-slate-900 mb-1.5 tracking-tight">
                    Enroll in Training
                  </h1>
                ...
                <form
                  ...
                  className="flex flex-col space-y-3.5 sm:space-y-5"
                >
                  <div className="group/input">
                    <label className="text-[10px] sm:text-[11px] font-bold dark:text-slate-400 text-slate-500 uppercase tracking-widest mb-1.5 block ml-1 transition-colors group-focus-within/input:text-primary-start">
                      Full Name
                    </label>
                    <div className="relative">
                      <User
                        size={16}
                        className="absolute left-4 top-1/2 -translate-y-1/2 dark:text-slate-400 text-slate-400 transition-colors group-focus-within/input:text-primary-start sm:w-[18px] sm:h-[18px]"
                      />
                      <input
                        type="text"
                        required
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        ...
                        <ArrowLeft
                          size={14}
                          className="rotate-180 sm:w-4 sm:h-4"
                        />
                      </>
                    )}
                  </button>

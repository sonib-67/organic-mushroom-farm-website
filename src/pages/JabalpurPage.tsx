  ...
  return (
    <div className="pt-24 pb-16 min-h-screen bg-slate-50 dark:bg-[#09090b]">
      <SEO
        ...
        description="Explore mushroom farming, training, and resources in Jabalpur. Learn more about our specialized mushroom farming techniques, training, and setup."
      />

...
const blogPosts = [
  {
    ...
    bg: "bg-blue-500/5",
    posts: [
      { id: "next-gen-commercial-mushroom-farming-india", customPath: "/articles/next-gen-commercial-mushroom-farming-india", title: "Next-Gen Commercial Mushroom Farming in India: Turnkey Setups, Global Exports", excerpt: "Welcome to the future of Indian agriculture. From visualizing your farm with 360-degree interactive models to exporting 20-ton containers.", date: "July 31, 2026" },

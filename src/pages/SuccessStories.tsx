    ...
    <div className="min-h-screen pt-32 pb-20">
      ...
      <section className="section-padding">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <a rel="nofollow noopener noreferrer" href="https://calendly.com/tanmaysomi/30min" target="_blank" className="gradient-bg px-12 py-5 rounded-2xl text-white font-black inline-flex items-center gap-3 hover:scale-105 transition-all">

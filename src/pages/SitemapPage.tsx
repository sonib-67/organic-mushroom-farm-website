...
export default function SitemapPage() {
  ...
  const educationalArticles = [
    ...
    { name: "Chandigarh Tricity Mushroom Farming Training Center", path: "/cities/chandigarh/chandigarh", desc: "Chandigarh, Mohali, Panchkula Mushroom Farming complete guide. Learn mushroom farm setup, high-yield spawn supply, commercial plans, subsidies & marketing support." },

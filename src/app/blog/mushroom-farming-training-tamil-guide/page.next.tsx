                ...
                <div className="glass p-8 md:p-12 rounded-3xl border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="prose prose-lg dark:prose-invert prose-slate max-w-none">
                        ...
                        <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                            இன்றைய வேளாண் உலகில், <strong><Link href="/" className="text-primary-start hover:underline">காளான் சாகுபடி</Link></strong> (Mushroom Farming) என்பது மிகவும் லாபகரமான மற்றும் குறைந்த முதலீட்டில் தொடரக்கூடிய ஒரு தொழிலாக மாறி வருகிறது. குறிப்பாக இளைஞர்கள் மற்றும் விவசாயிகள் இடையே <strong>காளான் பயிற்சி மையம்</strong> தேடும் போக்கு நாளுக்கு நாள் அதிகரித்து வருகிறது. இந்த வலைப்பதிவில், காளான் சாகுபடி எப்படி தொடங்குவது, என்ன பயிற்சி தேவை, மற்றும் <strong><Link href="/turnkey-projects" className="text-primary-start hover:underline">காளான் பண்ணை அமைப்பு</Link></strong> (Mushroom Setup) செய்வதற்கான படிப்படியான வழிமுறைகளை விரிவாக பார்க்கலாம்.
                        </p>
                        ...
                        <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
                            பலரும் காளான் சாகுபடியை தொடங்குவதற்கு முன், சரியான <strong><Link href="/training" className="text-primary-start hover:underline">மஷ்ரூம் பயிற்சி</Link></strong> பெறாமல் தொடங்கி நஷ்டம் அடைவதை பார்த்திருக்கிறோம். எனவே, தொழில்முறையான பயிற்சி பெறுவது மிகவும் அவசியம். எங்கள் பயிற்சியில் அடங்கியவை:
                        </p>
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                                    தயார் செய்யப்பட்ட சப்ஸ்ட்ரேட்டில் தரமான <strong><Link href="/spawn-seeds" className="text-primary-start hover:underline">காளான் ஸ்போனை</Link></strong> சரியான விகிதத்தில் கலந்து பைகளில் அடைக்க வேண்டும்.
                                </p>
                            </div>

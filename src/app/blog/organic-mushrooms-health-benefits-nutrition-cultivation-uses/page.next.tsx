        ...
        <div className="min-h-screen pt-32 pb-20">
            ...
            <article className="max-w-5xl mx-auto px-4 prose prose-invert">
                <div className="glass p-8 md:p-12 rounded-[3.5rem] border dark:border-white/5 border-black/5 space-y-12">
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed text-lg">
                        Whether you are looking to boost your gym recovery, improve your gut health, or switch to sustainable food choices, incorporating varieties like <Link href="/services/button-mushroom" className="text-blue-500 hover:underline">Button</Link>, <Link href="/services/oyster-mushroom" className="text-blue-500 hover:underline">Oyster</Link>, and <Link href="/services/milky-mushroom" className="text-blue-500 hover:underline">Milky</Link> mushrooms into your lifestyle can be a game-changer.
                    </p>
                    ...
                    <div className="mt-12 bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl p-8 text-center text-white">
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <Link href="/spawn-seeds" className="bg-white text-blue-900 px-8 py-4 rounded-xl font-bold hover:bg-blue-50 transition-colors">
                                Shop Mushroom Spawn
                            </Link>
                            <Link href="/training" className="bg-white/20 backdrop-blur border border-white/30 text-white px-8 py-4 rounded-xl font-bold hover:bg-white/30 transition-colors">

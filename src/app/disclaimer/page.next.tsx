          ...
          <div className="space-y-12">
            ...
            >
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                All the content on this website—including our <Link href="/blog" className="text-primary-start hover:underline">blogs</Link>, <Link href="/training" className="text-primary-start hover:underline">training videos</Link>, standard operating procedures (SOPs), and <Link href="/services" className="text-primary-start hover:underline">farm setup guides</Link>—is strictly for educational and informational purposes. 
              </p>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            >
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
                We are incredibly passionate about the profitability of mushroom farming and provide tools like our <Link href="/roi-calculator" className="text-primary-start hover:underline">Mushroom Business ROI Estimator</Link>. Please understand that:
              </p>

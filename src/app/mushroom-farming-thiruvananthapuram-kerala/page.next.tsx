        ...
        <div className="min-h-screen pt-32 pb-20 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4 mb-8">
                <div className="flex flex-wrap items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <ChevronRight size={14} />
                    <Link href="/states/kerala" className="hover:text-primary-start transition-colors">Kerala</Link>
                    <ChevronRight size={14} />
            ...
            <article className="max-w-4xl mx-auto px-4 prose prose-invert">
                <div className="glass p-8 md:p-12 rounded-[3.5rem] border dark:border-white/5 border-black/5 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="list-disc pl-5 space-y-2 dark:text-slate-300 text-slate-700">
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Oyster Mushroom</Link> (ചിപ്പി കൂൺ)</strong> — വളർത്താൻ എളുപ്പം, beginners-ന് ideal.</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Button Mushroom</Link> (ബട്ടൺ കൂൺ)</strong> — ഏറ്റവും കൂടുതൽ ഉപയോഗിക്കുന്ന ഭക്ഷ്യ മഷ്റൂം.</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Milky Mushroom</Link> (പാൽ കൂൺ)</strong> — ചൂടുള്ള കാലാവസ്ഥയിൽ commercial cultivation-ന് അനുയോജ്യം.</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Shiitake Mushroom</Link></strong> — പ്രീമിയം ഗൗർമെറ്റ് മാർക്കറ്റ് കാറ്റഗറി.</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Lion&apos;s Mane Mushroom</Link></strong> — വെൽനസ് മേഖലയിൽ വർദ്ധിച്ചുവരുന്ന ഡിമാൻഡ്.</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Reishi Mushroom</Link></strong> — ഔഷധ കൂൺ മേഖലയിൽ വളരെ പ്രശസ്തം.</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Turkey Tail Mushroom</Link></strong> — പ്രതിരോധ ശേഷി വർദ്ധിപ്പിക്കുന്ന ഫങ്ഷണൽ ഫുഡ്.</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Cordyceps Mushroom</Link></strong> — അതിവേഗം വളരുന്ന പ്രീമിയം ഔഷധ കൂൺ.</li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="list-disc pl-5 space-y-2 dark:text-slate-300 text-slate-700">
                            <li><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Oyster Mushroom</Link> Spawn (ചിപ്പി കൂൺ വിത്ത്)</li>
                            <li><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Button Mushroom</Link> Spawn (ബട്ടൺ കൂൺ വിത്ത്)</li>
                            <li><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Milky Mushroom</Link> Spawn (പാൽ കൂൺ വിത്ത്)</li>
                        </ul>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold dark:text-white text-slate-900 border-l-4 border-primary-start pl-4">
                            <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Medicinal Mushroom</Link> അവസരങ്ങൾ
                        </h3>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold dark:text-white text-slate-900 border-l-4 border-primary-start pl-4">
                            <Link href="/business-plan" className="hover:text-emerald-500 transition-colors">Business Plan</Link> & ROI Analysis
                        </h3>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4 dark:text-slate-300 text-slate-700">
                            ...
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">৩. <Link href="/spawn-seed" className="hover:text-emerald-500 transition-colors">Mushroom spawn</Link> എവിടെ ലഭിക്കും?</h4>
                            ...
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">৫. <Link href="/training" className="hover:text-emerald-500 transition-colors">Online training</Link> ലഭ്യമാണോ?</h4>
                                <p className="text-sm">അതെ, Malayalam, Hindi രണ്ട് ഭാഷകളിലും support-ഓടെ complete online training ലഭ്യമാണ്.</p>
                            </div>
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">৬. തിരുവനന്തപുരത്ത് <Link href="/training" className="hover:text-emerald-500 transition-colors">offline training</Link> ലഭിക്കുമോ?</h4>
                            ...
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">10. <Link href="/subsidy" className="hover:text-emerald-500 transition-colors">Government subsidy</Link> ലഭ്യമാണോ?</h4>
                            ...
                            <div>
                                ...
                                <p className="text-sm"><Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Oyster mushroom</Link> beginners-ന് തുടങ്ങാൻ ഏറ്റവും എളുപ്പമുള്ളത്.</p>
                            </div>
                            <div>
                            ...
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">13. നിങ്ങൾ <Link href="/book-consultant" className="hover:text-emerald-500 transition-colors">consultancy</Link> നൽകുന്നുണ്ടോ?</h4>
                                <p className="text-sm">അതെ, production മുതൽ marketing വരെ പൂർണ്ണമായ consultancy ലഭ്യമാണ്.</p>
                            </div>
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">14. <Link href="/turnkey-projects" className="hover:text-emerald-500 transition-colors">Turnkey project</Link> bhi milta hai?</h4>
                            ...
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">19. <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Medicinal mushroom</Link> farming profitable ആണോ?</h4>
                                <p className="text-sm">അതെ, Lion&apos;s Mane, Reishi പോലുള്ള varieties premium price-ൽ വിൽക്കുന്നു, margin കൂടുതലാണ്.</p>
                            </div>
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">20. <Link href="/business-plan" className="hover:text-emerald-500 transition-colors">Business plan</Link> എങ്ങനെ ലഭിക്കും?</h4>
                                <p className="text-sm">നിങ്ങളുടെ scale അനുസരിച്ച് customized project report, ROI analysis നൽകും.</p>
                            </div>
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">21. <Link href="/contact" className="hover:text-emerald-500 transition-colors">Contact</Link> എങ്ങനെ ചെയ്യാം?</h4>

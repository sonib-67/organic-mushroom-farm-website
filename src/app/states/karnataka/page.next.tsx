...
export default function KarnatakaPage() {
  return (
    <div className="pt-24 pb-16 min-h-screen bg-transparent dark:bg-transparent">
      <SEO
        title="Mushroom Farming in Karnataka | Cities"
        description="Find mushroom farming training, commercial setups, and resources across cities in Karnataka."
      />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-wrap items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
          ...
          <ChevronRight size={14} />
          <span className="font-semibold text-slate-900 dark:text-white">Karnataka</span>
        </div>
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-3xl">
            Select a city in Karnataka to find local mushroom farming training centers, consultants, and spawn suppliers.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link href="/cities/karnataka/bangalore"
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-6">
              Mushroom training, cultivation resources, and commercial setups in Bangalore.
            </p>
          ...
          <Link href="/cities/karnataka/mysuru"
            className="group glass p-8 rounded-2xl border border-black/5 dark:border-white/5 hover:border-brand-blue/30 transition-all hover:shadow-[0_10px_40px_-10px_rgba(124,58,237,0.15)] flex flex-col items-center text-center"
          >
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-brand-blue transition-colors">
              Mysuru
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-6">
              Mushroom Farming, Training, Spawn Supply, and Mushroom Farm Setup in Mysuru.
            </p>
            <div className="text-brand-blue font-semibold text-sm flex items-center gap-1 group-hover:translate-x-1 transition-transform mt-auto">
              View Resources <ChevronRight size={16} />
            </div>
          </Link>
          <Link href="/mushroom-farming-mangalore-karnataka"
            className="group glass p-8 rounded-2xl border border-black/5 dark:border-white/5 hover:border-brand-blue/30 transition-all hover:shadow-[0_10px_40px_-10px_rgba(124,58,237,0.15)] flex flex-col items-center text-center"
          >
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-brand-blue transition-colors">
              Mangalore
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-6">
              Mushroom Farming, Training, Spawn Supply, and Mushroom Farm Setup in Mangalore (Tulu/Kannada).
            </p>
            <div className="text-brand-blue font-semibold text-sm flex items-center gap-1 group-hover:translate-x-1 transition-transform mt-auto">
              View Resources <ChevronRight size={16} />
            </div>

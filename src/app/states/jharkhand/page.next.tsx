  ...
  return (
    <div className="pt-24 pb-16 min-h-screen bg-transparent dark:bg-transparent">
      <SEO
        ...
        description="Find mushroom farming training, spawn suppliers, and cultivation resources in Jharkhand."
      />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
          ...
          <ChevronRight size={14} />
          <span className="font-semibold text-slate-900 dark:text-white">Jharkhand</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link href="/cities/jharkhand/ranchi"

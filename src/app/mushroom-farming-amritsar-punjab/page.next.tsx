        ...
        <div className="min-h-screen pt-32 pb-20 relative overflow-hidden">
            ...
            <article className="max-w-4xl mx-auto px-4">
                ...
                <div className="mb-6 flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                    <Link href="/" className="hover:text-emerald-500 flex items-center gap-1 transition-colors">
                        Home
                    </Link>
                    <ArrowRight size={14} />
                    <Link href="/states" className="hover:text-emerald-500 transition-colors">States</Link>
                    <ArrowRight size={14} />
                    <Link href="/states/punjab" className="hover:text-emerald-500 transition-colors">Punjab</Link>
                    <ArrowRight size={14} />
                ...
                <div className="glass p-6 md:p-12 rounded-[2.5rem] border dark:border-white/5 border-black/5 space-y-8">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl md:text-2xl font-bold dark:text-white text-slate-900 border-l-4 border-emerald-500 pl-4">
                            ਕਿਹੜੀਆਂ <Link href="/mushroom-types" className="text-emerald-500 hover:underline">Mushroom Varieties</Link> ਉਗਾਈਆਂ ਜਾ ਸਕਦੀਆਂ ਹਨ?
                        </h2>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                            <div className="p-3 rounded-xl dark:bg-white/5 bg-black/5 border border-white/5 text-center text-xs md:text-sm font-semibold text-slate-800 dark:text-slate-200">
                                <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Oyster Mushroom</Link>
                                <span className="block text-[10px] text-slate-500 font-normal">beginners & commercial</span>
                            </div>
                            <div className="p-3 rounded-xl dark:bg-white/5 bg-black/5 border border-white/5 text-center text-xs md:text-sm font-semibold text-slate-800 dark:text-slate-200">
                                <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Button Mushroom</Link>
                                <span className="block text-[10px] text-slate-500 font-normal">ਸਭ ਤੋਂ ਵੱਧ ਵਰਤਿਆ ਜਾਣ ਵਾਲਾ</span>
                            </div>
                            <div className="p-3 rounded-xl dark:bg-white/5 bg-black/5 border border-white/5 text-center text-xs md:text-sm font-semibold text-slate-800 dark:text-slate-200">
                                <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Milky Mushroom</Link>
                                <span className="block text-[10px] text-slate-500 font-normal">commercial farms ਲਈ</span>
                            </div>
                            <div className="p-3 rounded-xl dark:bg-white/5 bg-black/5 border border-white/5 text-center text-xs md:text-sm font-semibold text-slate-800 dark:text-slate-200">
                                <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Shiitake Mushroom</Link>
                                <span className="block text-[10px] text-slate-500 font-normal">premium gourmet</span>
                            </div>
                            <div className="p-3 rounded-xl dark:bg-white/5 bg-black/5 border border-white/5 text-center text-xs md:text-sm font-semibold text-slate-800 dark:text-slate-200">
                                <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Lion's Mane Mushroom</Link>
                                <span className="block text-[10px] text-slate-500 font-normal">wellness market</span>
                            </div>
                            <div className="p-3 rounded-xl dark:bg-white/5 bg-black/5 border border-white/5 text-center text-xs md:text-sm font-semibold text-slate-800 dark:text-slate-200">
                                <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Reishi Mushroom</Link>
                                <span className="block text-[10px] text-slate-500 font-normal">medicinal mushroom</span>
                            </div>
                            <div className="p-3 rounded-xl dark:bg-white/5 bg-black/5 border border-white/5 text-center text-xs md:text-sm font-semibold text-slate-800 dark:text-slate-200">
                                <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Turkey Tail Mushroom</Link>
                                <span className="block text-[10px] text-slate-500 font-normal">health product</span>
                            </div>
                            <div className="p-3 rounded-xl dark:bg-white/5 bg-black/5 border border-white/5 text-center text-xs md:text-sm font-semibold text-slate-800 dark:text-slate-200">
                                <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Cordyceps Mushroom</Link>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="p-6 rounded-2xl dark:bg-white/5 bg-black/5 border border-white/5">
                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-2"><Link href="/training" className="hover:text-emerald-500 transition-colors">Online Mushroom Training</Link></h3>
                                ...
                                <Link href="/training" className="text-xs text-emerald-500 hover:underline font-bold flex items-center gap-1">
                                    Explore Course Details <ArrowRight size={14} />
                                </Link>
                            </div>
                            <div className="p-6 rounded-2xl dark:bg-white/5 bg-black/5 border border-white/5">
                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-2"><Link href="/training" className="hover:text-emerald-500 transition-colors">Offline Mushroom Training</Link></h3>
                                <p className="text-xs dark:text-slate-400 text-slate-600 mb-4">
                    ...
                    <div className="space-y-6 pt-6 border-t dark:border-white/10 border-black/10">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <h3 className="text-lg font-bold dark:text-white text-slate-900"><Link href="/articles/turnkey-commercial-setup" className="hover:text-emerald-500 transition-colors">Mushroom Farm Setup</Link></h3>
                                <p className="text-sm dark:text-slate-300 text-slate-700">
                                    ਇੱਕ ਸਫਲ <Link href="/articles/turnkey-commercial-setup" className="text-emerald-500 hover:underline font-semibold">Mushroom Farm Setup</Link> ਲਈ ਆਮ ਤੌਰ 'ਤੇ ਲੋੜ ਹੁੰਦੀ ਹੈ: Growing Room, Humidity Control, Ventilation, Storage Area, ਅਤੇ Quality Mushroom Spawn. Verka, Putlighar, Lawrence Road ਅਤੇ Mall Road ਵਿੱਚ site visit ਕਰਕੇ ਵੀ ਅਸੀਂ customized setup plan ਬਣਾ ਕੇ ਦਿੰਦੇ ਹਾਂ।
                                </p>
                            </div>
                            <div className="space-y-4">
                                <h3 className="text-lg font-bold dark:text-white text-slate-900"><Link href="/spawn-seed" className="hover:text-emerald-500 transition-colors">Mushroom Spawn Supply</Link></h3>
                                <p className="text-sm dark:text-slate-300 text-slate-700">
                                    Reliable spawn cultivation ਦੀ ਸਫਲਤਾ ਲਈ ਸਭ ਤੋਂ ਜ਼ਰੂਰੀ factor ਹੈ। ਅਸੀਂ ਮੁਹੱਈਆ ਕਰਵਾਉਂਦੇ ਹਾਂ: <Link href="/spawn-seed" className="hover:text-emerald-500 transition-colors">Oyster Mushroom Spawn, Button Mushroom Spawn, Milky Mushroom Spawn</Link>. Amritsar, Ajnala, Tarn Taran, Attari, Jandiala Guru, Chogawan, Lopoke ਅਤੇ Verka Rural Belt ਤੱਕ pan-India delivery ਨਾਲ <Link href="/spawn-seed" className="text-emerald-500 hover:underline font-semibold">spawn</Link> ਭੇਜਿਆ ਜਾਂਦਾ ਹੈ।
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 pt-6 border-t dark:border-white/10 border-black/10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="glass p-5 rounded-2xl border border-white/5">
                                <h3 className="font-bold text-slate-900 dark:text-white text-sm mb-1"><Link href="/contact" className="hover:text-emerald-500 transition-colors">Fresh Mushroom Sale</Link></h3>
                            ...
                            <div className="glass p-5 rounded-2xl border border-white/5">
                                <h3 className="font-bold text-slate-900 dark:text-white text-sm mb-1"><Link href="/contact" className="hover:text-emerald-500 transition-colors">Dry Mushroom Business</Link></h3>
                            ...
                            <div className="glass p-5 rounded-2xl border border-white/5">
                                <h3 className="font-bold text-slate-900 dark:text-white text-sm mb-1"><Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Medicinal Mushroom</Link> ਦੇ ਮੌਕੇ</h3>
                                <p className="text-xs dark:text-slate-400 text-slate-600">Wellness ਪ੍ਰਤੀ ਜਾਗਰੂਕਤਾ ਵਧਣ ਨਾਲ <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Lion's Mane, Reishi ਅਤੇ Cordyceps</Link> ਵਰਗੇ medicinal mushroom ਦੀ ਮੰਗ ਵਧ ਰਹੀ ਹੈ। ਇਹ premium price 'ਤੇ ਵਿਕਦੇ ਹਨ ਅਤੇ ਵਧੀਆ ਮੁਨਾਫ਼ਾ ਦਿੰਦੇ ਹਨ।</p>
                            </div>
                        </div>

                        <div className="space-y-4 mt-6">
                            <div>
                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1"><Link href="/book-consultant" className="hover:text-emerald-500 transition-colors">Mushroom Consultancy</Link></h3>
                                <p className="text-sm dark:text-slate-300 text-slate-700">
                                    Professional <Link href="/book-consultant" className="text-emerald-500 hover:underline font-semibold">consultancy</Link> ਮਦਦ ਕਰਦੀ ਹੈ: Farm Planning, Technical Guidance, Business Development, Market Expansion. Expert advice se business mistakes kaafi kam ho jaati hain.
                                </p>
                            </div>
                            <div>
                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1"><Link href="/articles/turnkey-commercial-setup" className="hover:text-emerald-500 transition-colors">Turnkey Mushroom Projects</Link></h3>
                                <p className="text-sm dark:text-slate-300 text-slate-700">
                                    ਵੱਡੇ investors ਲਈ ਅਸੀਂ <Link href="/articles/turnkey-commercial-setup" className="text-emerald-500 hover:underline font-semibold">turnkey project</Link> ਦਿੰਦੇ ਹਾਂ — ਇਸ ਵਿੱਚ farm design, infrastructure planning, equipment selection ਅਤੇ operational guidance ਸਭ ਸ਼ਾਮਲ ਹੈ।
                                </p>
                            </div>
                            <div>
                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1">Business Plan & ROI Analysis</h3>
                                <p className="text-sm dark:text-slate-300 text-slate-700">
                                    Mushroom business ਸ਼ੁਰੂ ਕਰਨ ਤੋਂ ਪਹਿਲਾਂ ਉੱਦਮੀਆਂ ਨੂੰ ਵਿਚਾਰਨਾ ਚਾਹੀਦਾ ਹੈ: Investment Budget, Production Capacity, Market Demand, Operating Costs, Revenue Opportunities. Aapke scale ke hisaab se hum <Link href="/business-plan" className="text-emerald-500 hover:underline font-semibold">customized business plan</Link> aur project report banaa kar dete hain, jo bank loan ya subsidy application ke liye bhi use ho sakta hai.
                                </p>
                            </div>
                            <div>
                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1"><Link href="/subsidy" className="hover:text-emerald-500 transition-colors">Government Subsidy Opportunities</Link></h3>
                                <p className="text-sm dark:text-slate-300 text-slate-700">
                                    ਯੋਗ ਕਿਸਾਨ ਅਤੇ ਉੱਦਮੀ ਖੇਤੀਬਾੜੀ, food processing ਅਤੇ entrepreneurship support ਯੋਜਨਾਵਾਂ ਦਾ ਲਾਭ eligibility ਦੇ ਆਧਾਰ 'ਤੇ ਲੈ ਸਕਦੇ ਹਨ। ਸਹੀ ਯੋਜਨਾ ਪਛਾਣਨ ਅਤੇ documentation ਤਿਆਰ ਕਰਨ ਵਿੱਚ ਅਸੀਂ ਮਦਦ ਕਰਦੇ ਹਾਂ। <Link href="/subsidy" className="text-emerald-500 hover:underline font-semibold">Subsidy opportunities check karo.</Link>
                                </p>
                            </div>
                            <div>
                    ...
                    <div className="space-y-6 pt-6 border-t dark:border-white/10 border-black/10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {[
                                ...
                                {
                                    q: <>3. <Link href="/spawn-seed" className="hover:text-emerald-500 transition-colors">Mushroom spawn</Link> ਕਿੱਥੋਂ ਮਿਲੇਗਾ?</>,
                                    a: "ਸਾਡੇ ਵੱਲੋਂ ਪੂਰੇ Punjab ਅਤੇ pan-India delivery ਨਾਲ spawn ਖਰੀਦਿਆ ਜਾ ਸਕਦਾ ਹੈ।"
                                },
                                {
                                    q: <>4. <Link href="/training" className="hover:text-emerald-500 transition-colors">Training</Link> kaise join karein?</>,
                                    a: "WhatsApp ke through contact karke online ya offline training ke liye registration kiya ja sakta hai."
                                },
                                {
                                    q: <>5. <Link href="/training" className="hover:text-emerald-500 transition-colors">Online training</Link> ਉਪਲਬਧ ਹੈ?</>,
                                    a: "ਹਾਂ, Punjabi ਅਤੇ Hindi ਦੋਵਾਂ ਭਾਸ਼ਾਵਾਂ ਵਿੱਚ support ਨਾਲ ਪੂਰੀ online training ਉਪਲਬਧ ਹੈ।"
                                },
                                {
                                    q: <>6. Amritsar ਵਿੱਚ <Link href="/training" className="hover:text-emerald-500 transition-colors">offline training</Link> ਮਿਲੇਗੀ?</>,
                                ...
                                {
                                    q: <>10. <Link href="/subsidy" className="hover:text-emerald-500 transition-colors">Government subsidy</Link> ਉਪਲਬਧ ਹੈ?</>,
                                ...
                                },
                                {
                                    ...
                                    a: <><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Oyster mushroom</Link> beginners ਲਈ ਸ਼ੁਰੂ ਕਰਨ ਲਈ ਸਭ ਤੋਂ ਸੌਖਾ ਹੈ।</>
                                },
                                {
                                ...
                                {
                                    q: <>13. ਕੀ ਤੁਸੀਂ <Link href="/book-consultant" className="hover:text-emerald-500 transition-colors">consultancy</Link> ਦਿੰਦੇ ਹੋ?</>,
                                    a: "ਹਾਂ, production ਤੋਂ marketing ਤੱਕ ਪੂਰੀ consultancy ਉਪਲਬਧ ਹੈ।"
                                },
                                {
                                    q: <>14. <Link href="/turnkey-projects" className="hover:text-emerald-500 transition-colors">Turnkey project</Link> bhi milta hai?</>,
                                ...
                                {
                                    q: <>20. <Link href="/business-plan" className="hover:text-emerald-500 transition-colors">Business plan</Link> ਕਿਵੇਂ ਮਿਲੇਗਾ?</>,
                                    a: "ਤੁਹਾਡੇ scale ਅਨੁਸਾਰ customized project report ਅਤੇ ROI analysis ਦਿੱਤਾ ਜਾਂਦਾ ਹੈ।"
                                },
                                {
                                    q: <>21. <Link href="/contact" className="hover:text-emerald-500 transition-colors">Contact</Link> ਕਿਵੇਂ ਕਰੀਏ?</>,

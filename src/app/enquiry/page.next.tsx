      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        {submitted ? (
          ...
          >
            ...
            <Link href="/" className="inline-flex items-center justify-center px-6 py-2.5 rounded-full bg-gradient-to-r from-primary-start to-primary-end text-white font-bold text-sm hover:shadow-lg hover:-translate-y-1 transition-all">

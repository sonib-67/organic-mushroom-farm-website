        ...
        <div className="min-h-screen pt-32 pb-20 relative overflow-hidden">
            ...
            <article className="max-w-4xl mx-auto px-4">
                ...
                <div className="mb-6 flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <Link href="/states" className="hover:text-brand-blue transition-colors">States</Link>
                    <span className="text-slate-400">/</span>
                    <Link href="/states/tamil-nadu" className="hover:text-brand-blue transition-colors">Tamil Nadu</Link>
                    <span className="text-slate-400">/</span>
                ...
                <div className="glass p-6 md:p-12 rounded-[2.5rem] border dark:border-white/5 border-black/5 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                            மதுரை ஒரு hot and dry climate கொண்ட நகரம் — கோடையில் temperature 40°C-க்கும் மேல் செல்கிறது. இது <Link href="/mushroom-types" className="text-emerald-500 hover:underline">milky mushroom</Link>-க்கு மிகவும் suitable, ஏனெனில் இது heat-tolerant variety. <Link href="/mushroom-types" className="text-emerald-500 hover:underline">Oyster mushroom</Link>-ம் Tamil Nadu-வின் இந்த warm climate-ல் நன்றாக வளரும்.
                        </p>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                            <Link href="/mushroom-types" className="text-emerald-500 hover:underline">Button mushroom</Link>-க்கு குளிர்ந்த temperature (16-22°C) தேவை, அதனால் மதுரையில் இதற்கு cooling setup அல்லது semi-controlled room தேவைப்படும். வடிபட்டி, கொட்டாம்பட்டி, செடப்பட்டி போன்ற peri-urban blocks-ல் poly-shed அமைத்து, ஆண்டு முழுவதும் production செய்யலாம்.
                        </p>
                    </div>
                    ...
                    <div className="space-y-6 pt-6 border-t dark:border-white/10 border-black/10">
                        <div className="space-y-4">
                            <h3 className="text-lg font-bold dark:text-white text-slate-900"><Link href="/articles/turnkey-commercial-setup" className="hover:text-emerald-500 transition-colors">Mushroom Farm Setup Services</Link></h3>
                    ...
                    <div className="space-y-6 pt-6 border-t dark:border-white/10 border-black/10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="p-6 rounded-2xl dark:bg-white/5 bg-black/5 border border-white/5">
                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-2"><Link href="/training" className="hover:text-emerald-500 transition-colors">Online Mushroom Training Program</Link></h3>
                            ...
                            <div className="p-6 rounded-2xl dark:bg-white/5 bg-black/5 border border-white/5">
                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-2"><Link href="/training" className="hover:text-emerald-500 transition-colors">Offline Practical Mushroom Training</Link></h3>
                                <p className="text-xs dark:text-slate-400 text-slate-600 mb-4">
                    ...
                    <div className="space-y-6 pt-6 border-t dark:border-white/10 border-black/10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="glass p-5 rounded-2xl border border-white/5">
                                <h3 className="font-bold text-slate-900 dark:text-white text-sm mb-1"><Link href="/spawn-seed" className="hover:text-emerald-500 transition-colors">Mushroom Spawn Supply</Link></h3>
                            ...
                            <div className="glass p-5 rounded-2xl border border-white/5">
                                <h3 className="font-bold text-slate-900 dark:text-white text-sm mb-1"><Link href="/contact" className="hover:text-emerald-500 transition-colors">Fresh Mushroom Supply</Link></h3>
                            ...
                            <div className="glass p-5 rounded-2xl border border-white/5">
                                <h3 className="font-bold text-slate-900 dark:text-white text-sm mb-1"><Link href="/contact" className="hover:text-emerald-500 transition-colors">Dry Mushroom Products</Link></h3>
                        ...
                        <div className="space-y-4 mt-6">
                            <div>
                                ...
                                <p className="text-sm dark:text-slate-300 text-slate-700">
                                    Wellness market-ல் interest அதிகரிக்கும் varieties: <Link href="/mushroom-types" className="text-emerald-500 hover:underline">Lion's Mane</Link> (cognitive wellness), <Link href="/mushroom-types" className="text-emerald-500 hover:underline">Reishi</Link> (immunity), <Link href="/mushroom-types" className="text-emerald-500 hover:underline">Cordyceps</Link> (premium medicinal), <Link href="/mushroom-types" className="text-emerald-500 hover:underline">Turkey Tail</Link> (functional food), <Link href="/mushroom-types" className="text-emerald-500 hover:underline">Shiitake</Link> (gourmet restaurant segment). இந்த category இன்னும் India-வில் early-stage-ல் தான் இருக்கிறது, அதனால் இப்போது enter ஆகும் entrepreneurs-க்கு first-mover advantage கிடைக்கும்.
                                </p>
                            </div>
                            <div>
                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1"><Link href="/contact" className="hover:text-emerald-500 transition-colors">Mushroom Consultancy Services</Link></h3>
                                <p className="text-sm dark:text-slate-300 text-slate-700">
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1"><Link href="/blog/mushroom-farming-business-plan-india" className="hover:text-emerald-500 transition-colors">Mushroom Business Plan & ROI</Link></h3>
                                <p className="text-sm dark:text-slate-300 text-slate-700">
                                    Investment செய்வதற்கு முன் இவற்றை evaluate செய்யவும்: Investment budget, Production capacity, Market demand, Sales channels, Operating costs. ஒரு structured <Link href="/business-plan" className="text-emerald-500 hover:underline font-semibold">Mushroom Business Plan</Link> business risks-ஐ குறைக்க உதவும்.
                                </p>
                            </div>
                            <div>
                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1"><Link href="/subsidy" className="hover:text-emerald-500 transition-colors">Government Subsidy</Link> & Marketing Support</h3>
                                <p className="text-sm dark:text-slate-300 text-slate-700">
                    ...
                    <div className="space-y-6 pt-6 border-t dark:border-white/10 border-black/10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {[
                                ...
                                {
                                    q: <>3. <Link href="/spawn-seed" className="hover:text-emerald-500 transition-colors">Mushroom spawn</Link> எங்கே வாங்குவது?</>,
                                ...
                                {
                                    q: <>4. <Link href="/training" className="hover:text-emerald-500 transition-colors">Mushroom training</Link> எப்படி join செய்வது?</>,
                                    a: "Online மற்றும் offline, இரண்டு formats-ம் available — உங்கள் availability-ஐ பொறுத்து தேர்வு செய்யலாம்."
                                },
                                {
                                    q: <>5. <Link href="/training" className="hover:text-emerald-500 transition-colors">Online training</Link> கிடைக்குமா?</>,
                                    a: "ஆம், working professionals மற்றும் busy schedule உள்ளவர்களுக்கு online training convenient."
                                },
                                {
                                    q: <>6. <Link href="/training" className="hover:text-emerald-500 transition-colors">Offline/hands-on training</Link>-ம் கிடைக்குமா?</>,
                                ...
                                {
                                    q: <>10. <Link href="/subsidy" className="hover:text-emerald-500 transition-colors">Government subsidy</Link> கிடைக்குமா?</>,
                                ...
                                },
                                {
                                    ...
                                    a: <><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Oyster mushroom</Link> beginners-க்கு எளிமையானது; heat-tolerant milky mushroom-ம் suitable; button mushroom-க்கு cooling setup தேவை.</>
                                },
                                {
                                ...
                                {
                                    q: <>13. <Link href="/book-consultant" className="hover:text-emerald-500 transition-colors">Consultancy service</Link> கிடைக்குமா?</>,
                                    a: "ஆம், farm planning முதல் market development வரை consultancy available."
                                },
                                {
                                    q: <>14. <Link href="/turnkey-projects" className="hover:text-emerald-500 transition-colors">Turnkey project setup</Link> கிடைக்குமா?</>,
                                ...
                                {
                                    q: <>19. மதுரையில் <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">medicinal mushroom</Link> (Lion's Mane, Reishi, Cordyceps) market எப்படி உள்ளது?</>,

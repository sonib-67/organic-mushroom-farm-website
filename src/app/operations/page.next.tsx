    ...
    <div className="min-h-screen pt-24 md:pt-32 pb-20">
      ...
      <article className="max-w-4xl mx-auto px-6">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-slate-600 dark:text-slate-400 leading-relaxed space-y-6">
          ...
          <p>
            Whether you are managing a single grow room or an industrial-scale <Link href="/services/turnkey-setup" className="text-primary-start hover:underline font-semibold">commercial facility</Link>, mushroom farm operations require military-grade discipline, strict hygiene, and well-defined workflows. A great setup or <Link href="/spawn-seeds" className="text-primary-start hover:underline font-semibold">high-quality spawn</Link> won't mean much if your daily operational management is chaotic.
          </p>
          <p>

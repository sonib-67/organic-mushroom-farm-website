        ...
        {stories.map((s, i) => (
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 border-t dark:border-white/5 border-black/5 pt-8">
              ...
              <Link href={`/success-story/${s.name.toLowerCase().replace(' ', '-')}`} className="flex items-center gap-2 dark:text-white text-slate-900 font-bold text-sm uppercase tracking-widest group dark:bg-white/5 bg-black/5 px-6 py-4 rounded-xl hover:bg-white/10 transition-colors">

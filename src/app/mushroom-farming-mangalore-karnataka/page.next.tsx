        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-slate-600 dark:text-slate-400 leading-relaxed space-y-6">
          ...
          <ul className="space-y-4 my-6">
            <li className="flex gap-3 items-start">
              ...
              <div>
                <strong className="dark:text-white text-slate-900 block mb-1"><Link href="/services/oyster-mushroom" className="text-primary-start hover:underline">Oyster Mushrooms</Link>:</strong>
            ...
            <li className="flex gap-3 items-start">
              <CheckCircle2 className="text-primary-start shrink-0 mt-1" size={20} />
              <div>
                <strong className="dark:text-white text-slate-900 block mb-1"><Link href="/services/milky-mushroom" className="text-primary-start hover:underline">Milky Mushrooms</Link>:</strong>
            ...
            <li className="flex gap-3 items-start">
              <CheckCircle2 className="text-primary-start shrink-0 mt-1" size={20} />
              <div>
                <strong className="dark:text-white text-slate-900 block mb-1"><Link href="/services/button-mushroom" className="text-primary-start hover:underline">Button Mushrooms</Link>:</strong>
                While these require insulated, temperature-controlled AC rooms (as they prefer cooler environments), they command premium prices in local supermarkets and luxury hotels, making the <Link href="/services/turnkey-setup" className="text-primary-start hover:underline">initial infrastructure investment</Link> highly worthwhile.
              </div>
            </li>
          </ul>

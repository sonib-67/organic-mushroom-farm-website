        ...
        <div className="min-h-screen pt-32 pb-20 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4 mb-8">
                <div className="flex flex-wrap items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <ChevronRight size={14} />
                    <Link href="/states/west-bengal" className="hover:text-primary-start transition-colors">West Bengal</Link>
                    <ChevronRight size={14} />
            ...
            <article className="max-w-4xl mx-auto px-4 prose prose-invert">
                <div className="glass p-8 md:p-12 rounded-[3.5rem] border dark:border-white/5 border-black/5 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed font-medium">
                            Organic Mushroom Farm আপনাকে দিচ্ছে হাতে-কলমে (hands-on) <Link href="/training" className="text-emerald-500 hover:underline">মাশরুম চাষের ট্রেনিং</Link>। শুধু তাই নয়, আপনার বাজেট অনুযায়ী একটি পারফেক্ট <Link href="/articles/turnkey-commercial-setup" className="text-emerald-500 hover:underline">commercial farm setup</Link> করতে আমরা সম্পূর্ণ সাহায্য করি, সাথে দিচ্ছি হাই-কোয়ালিটি <Link href="/spawn-seed" className="text-emerald-500 hover:underline">মাশরুম স্পন (Spawn/বীজ)</Link>।
                        </p>
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold dark:text-white text-slate-900 border-l-4 border-primary-start pl-4">
                            <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Commercial Mushroom Varieties</Link> (বোতাম মাশরুম, ঝিনুক মাশরুম এবং অন্যান্য)
                        </h3>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                            আমাদের ট্রেনিং এবং বীজ সরবরাহে সমস্ত ধরনের প্রিমিয়াম এবং কমার্শিয়াল মাশরুম অন্তর্ভুক্ত রয়েছে:
                        </p>
                        <ul className="list-disc pl-5 space-y-2 dark:text-slate-300 text-slate-700">
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Oyster Mushroom</Link> (ঝিনুক মাশরুম)</strong> — চাষ করা সহজ, beginners ও commercial farming-এর জন্য উপযুক্ত।</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Button Mushroom</Link> (বোতাম মাশরুম)</strong> — ভারতের সবচেয়ে জনপ্রিয় এবং চাহিদাপূর্ণ ভোজ্য মাশরুম।</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Milky Mushroom</Link> (দুধে মাশরুম)</strong> — গরমের দিনে বাণিজ্যিক উৎপাদনের জন্য অত্যন্ত সাশ্রয়ী।</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Shiitake Mushroom</Link></strong> — প্রিমিয়াম গুরমে ক্যাটাগরি, যার মার্কেট ভ্যালু অনেক বেশি।</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Lion&apos;s Mane Mushroom</Link></strong> — ওয়েলনেস এবং ব্রেইন হেলথ মার্কেটে ক্রমবর্ধমান চাহিদা।</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Reishi Mushroom</Link></strong> — ঔষধি মাশরুম ইন্ডাস্ট্রির একটি অত্যন্ত মূল্যবান অংশ।</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Turkey Tail Mushroom</Link></strong> — ক্যান্সার প্রতিরোধক ও ইমিউনিটি বুস্টার হিসেবে ব্যবহৃত।</li>
                            <li><strong><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Cordyceps Mushroom</Link></strong> — অত্যন্ত প্রিমিয়াম এবং ভিআইপি ওষুধি মাশরুম ক্যাটাগরি।</li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold dark:text-white text-slate-900 border-l-4 border-primary-start pl-4">
                            <Link href="/articles/turnkey-commercial-setup" className="hover:text-emerald-500 transition-colors">Mushroom Farm Setup</Link>
                        </h3>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold dark:text-white text-slate-900 border-l-4 border-primary-start pl-4">
                            <Link href="/training" className="hover:text-emerald-500 transition-colors">Online Mushroom Training</Link>
                        </h3>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold dark:text-white text-slate-900 border-l-4 border-primary-start pl-4">
                            <Link href="/training" className="hover:text-emerald-500 transition-colors">Offline Mushroom Training</Link>
                        </h3>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold dark:text-white text-slate-900 border-l-4 border-primary-start pl-4">
                            <Link href="/spawn-seed" className="hover:text-emerald-500 transition-colors">Mushroom Spawn Supply</Link>
                        </h3>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold dark:text-white text-slate-900 border-l-4 border-primary-start pl-4">
                            <Link href="/contact" className="hover:text-emerald-500 transition-colors">Dry Mushroom Products</Link>
                        </h3>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold dark:text-white text-slate-900 border-l-4 border-primary-start pl-4">
                            <Link href="/book-consultant" className="hover:text-emerald-500 transition-colors">Mushroom Consultancy</Link>
                        </h3>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold dark:text-white text-slate-900 border-l-4 border-primary-start pl-4">
                            <Link href="/turnkey-projects" className="hover:text-emerald-500 transition-colors">Turnkey Mushroom Projects</Link>
                        </h3>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold dark:text-white text-slate-900 border-l-4 border-primary-start pl-4">
                            <Link href="/business-plan" className="hover:text-emerald-500 transition-colors">Business Plan & ROI Analysis</Link>
                        </h3>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold dark:text-white text-slate-900 border-l-4 border-primary-start pl-4">
                            <Link href="/subsidy" className="hover:text-emerald-500 transition-colors">Government Subsidy Opportunities</Link>
                        </h3>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4 dark:text-slate-300 text-slate-700">
                            ...
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">৩. <Link href="/spawn-seed" className="hover:text-emerald-500 transition-colors">Mushroom spawn</Link> কোথায় পাওয়া যাবে?</h4>
                                <p className="text-sm">আমাদের কাছ থেকে সমগ্র North Bengal এবং pan-India delivery-সহ spawn কেনা যায়।</p>
                            </div>
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">৪. <Link href="/training" className="hover:text-emerald-500 transition-colors">Training</Link> kaise join karein?</h4>
                            ...
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">৫. <Link href="/training" className="hover:text-emerald-500 transition-colors">Online training</Link> উপলব্ধ আছে?</h4>
                                <p className="text-sm">হ্যাঁ, Bengali, Nepali এবং Hindi — তিন ভাষার support-সহ সম্পূর্ণ online training উপলব্ধ।</p>
                            </div>
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">৬. শিলিগুড়িতে <Link href="/training" className="hover:text-emerald-500 transition-colors">offline training</Link> পাওয়া যাবে?</h4>
                            ...
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">১০. <Link href="/subsidy" className="hover:text-emerald-500 transition-colors">Government subsidy</Link> উপলব্ধ আছে?</h4>
                            ...
                            <div>
                                ...
                                <p className="text-sm"><Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Oyster mushroom</Link> beginners-দের জন্য শুরু করার সবচেয়ে সহজ বিকল্প।</p>
                            </div>
                            <div>
                            ...
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">১৩. আপনারা কি <Link href="/book-consultant" className="hover:text-emerald-500 transition-colors">consultancy</Link> প্রদান করেন?</h4>
                                <p className="text-sm">হ্যাঁ, production থেকে marketing পর্যন্ত সম্পূর্ণ consultancy উপলব্ধ।</p>
                            </div>
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">১৪. <Link href="/turnkey-projects" className="hover:text-emerald-500 transition-colors">Turnkey project</Link> bhi milta hai?</h4>
                            ...
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">১৯. <Link href="/mushroom-types" className="hover:text-emerald-500 transition-colors">Medicinal mushroom</Link> farming profitable কি?</h4>
                                <p className="text-sm">হ্যাঁ, Lion&apos;s Mane, Reishi-র মতো varieties premium price-এ বিক্রি হয়, margin বেশি।</p>
                            </div>
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">২০. <Link href="/business-plan" className="hover:text-emerald-500 transition-colors">Business plan</Link> কীভাবে পাওয়া যাবে?</h4>
                                <p className="text-sm">আপনার scale অনুযায়ী customized project report এবং ROI analysis দেওয়া হয়।</p>
                            </div>
                            <div>
                                <h4 className="font-bold dark:text-white text-slate-900">২১. <Link href="/contact" className="hover:text-emerald-500 transition-colors">Contact</Link> কীভাবে করবেন?</h4>

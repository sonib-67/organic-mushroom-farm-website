            ...
            <article className="max-w-4xl mx-auto px-4 prose prose-invert">
                <div className="glass p-8 md:p-12 rounded-[3.5rem] border dark:border-white/5 border-black/5 space-y-8">
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed font-medium">
                        ...
                        <Link href="/" className="text-primary-start hover:underline"> mushroom farming </Link> 
                    ...
                    <div className="space-y-4">
                        <ul className="list-none space-y-4 dark:text-slate-300 text-slate-700">
                            ...
                            <li className="flex gap-3"><CheckCircle2 className="text-primary-start shrink-0 mt-1" size={20} /> <span><strong>Online Mushroom Training:</strong> घर बैठे लाइव प्रैक्टिकल क्लासेज, वीडियो मॉड्युल्स और लाइफटाइम चैट असिस्टेंस के साथ <Link href="/training" className="text-primary-start hover:underline">सीखें</Link>।</span></li>
                            <li className="flex gap-3"><CheckCircle2 className="text-primary-start shrink-0 mt-1" size={20} /> <span><strong>Offline Mushroom Training:</strong> जयपुर स्थित हमारे <Link href="/workshop" className="text-primary-start hover:underline">ट्रेनिंग सेंटर</Link> पर आकर हाथों से बेड बनाना, स्पॉनिंग करना और क्रॉप हार्वेस्टिंग का लाइव अनुभव प्राप्त करें।</span></li>
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-6">
                        ...
                        निम्नलिखित मानकों पर <Link href="/services" className="text-primary-start hover:underline">सेटअप तैयार</Link> करवाते हैं:
                    </p>
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-6">
                        ...
                        है। हमारी टीम आपके लिए एक सटीक <Link href="/business-plan" className="text-primary-start hover:underline">Mushroom Business Project Report</Link> तैयार करती है:
                    </p>
                    <ul className="list-disc pl-5 space-y-2 dark:text-slate-300 text-slate-700">

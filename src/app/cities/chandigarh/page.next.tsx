                ...
                <div className="glass p-8 md:p-12 rounded-[3.5rem] border dark:border-white/5 border-black/5 space-y-8">
                    ...
                    <div className="space-y-6 mb-8">
                        ...
                        <div className="bg-black/5 dark:bg-white/5 p-6 rounded-2xl border border-black/5 dark:border-white/5">
                            ...
                            <p className="text-sm dark:text-slate-300 text-slate-700">उत्तर: NHB (National Horticulture Board) और पंजाब/हरियाणा कृषि विभाग के अंतर्गत प्रोजेक्ट कॉस्ट पर भारी सब्सिडी मिलती है। हमारी टीम बैंक लोन और <Link href="/subsidy" className="text-primary-start hover:underline">Government Subsidy</Link> के लिए जरूरी DPR तैयार करने में आपकी पूरी मदद करती है।</p>
                        </div>
                        <div className="bg-black/5 dark:bg-white/5 p-6 rounded-2xl border border-black/5 dark:border-white/5">

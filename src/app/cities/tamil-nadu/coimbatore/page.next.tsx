                ...
                <div className="glass p-8 md:p-12 rounded-[3.5rem] border dark:border-white/5 border-black/5 space-y-8">
                    ...
                    <div className="space-y-6 mb-8">
                        <div className="glass-dark p-6 rounded-2xl border dark:border-white/5 border-black/5">
                            ...
                            <p className="dark:text-slate-400 text-slate-600 text-sm">பிகினர்களுக்கு இதுதான் பெஸ்ட் சாய்ஸ். Nalla ஈஸியா வளர்க்கலாம். Thondamuthur மற்றும் Annur Belt-ல இருக்குற லோக்கல் மார்க்கெட்டுகள்ல இதுக்கு எப்பவும் நல்ல வரவேற்பு இருக்கு. <Link href="/services/oyster-mushroom" className="text-primary-start hover:underline">Oyster Mushroom</Link> பற்றி மேலும் அறியவும்.</p>
                        </div>
                        <div className="glass-dark p-6 rounded-2xl border dark:border-white/5 border-black/5">
                            <h3 className="text-lg font-bold dark:text-white text-slate-900 mb-2">2. Button Mushroom (மொட்டு காளான்)</h3>
                            <p className="dark:text-slate-400 text-slate-600 text-sm">RS Puram, Saibaba Colony-ல இருக்குற சூப்பர் மார்க்கெட்ஸ் மற்றும் ஹை-எண்ட் ரெஸ்டாரண்டுகள்ல இதுக்கு எப்பவும் பிரீமியம் டிமாண்ட் தான். <Link href="/services/button-mushroom" className="text-primary-start hover:underline">Button Mushroom</Link> பற்றி படிக்க.</p>
                        </div>
                        <div className="glass-dark p-6 rounded-2xl border dark:border-white/5 border-black/5">
                            <h3 className="text-lg font-bold dark:text-white text-slate-900 mb-2">3. Milky Mushroom (பால் காளான்)</h3>
                            <p className="dark:text-slate-400 text-slate-600 text-sm">நம்ம ஊரு கோடை கால வெயிலைத் தாங்கி வளரக்கூடிய சூப்பரான வெரைட்டி. Palladam மற்றும் Tiruppur வெயில் ஏரியாக்களுக்கு இது செம்ம கச்சிதமா செட் ஆகும். <Link href="/services/milky-mushroom" className="text-primary-start hover:underline">Milky Mushroom</Link> விவரங்கள்.</p>
                        </div>
                        <div className="glass-dark p-6 rounded-2xl border dark:border-white/5 border-black/5">
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
                        ஒரு கமர்ஷியல் காளான் பண்ணை வைக்கணும்னா சும்மா ஏனோ தானோனு பண்ணக் கூடாதுங்க. பக்காவான <Link href="/services/turnkey-setup" className="text-primary-start hover:underline">Mushroom Farm Setup</Link> முக்கியம்:
                    </p>
                    <ul className="list-none space-y-4 dark:text-slate-300 text-slate-700 mb-8">
                    ...
                    <ul className="list-none space-y-4 dark:text-slate-300 text-slate-700 mb-8">
                        <li className="flex gap-3 items-start"><CheckCircle2 className="text-primary-start shrink-0 mt-1" size={18} /> <span><strong>Business Plan & ROI:</strong> பிசினஸ்ல இறங்குறதுக்கு முன்னாடி Startup Capital எவ்ளோ, Operating Costs என்ன, Revenue Potential எவ்ளோ வரும்னு ஒரு தெளிவான ப்ளூபிரின்ட் ரெடி பண்ணிக்கோங்க. <Link href="/blog/mushroom-farming-business-plan-india" className="text-primary-start hover:underline">Business Plan</Link> விவரங்களுக்கு பார்க்கவும்.</span></li>

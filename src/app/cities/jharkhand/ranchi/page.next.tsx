                ...
                <div className="glass p-8 md:p-12 rounded-[3.5rem] border dark:border-white/5 border-black/5 space-y-8">
                    ...
                    <div className="space-y-6 mb-8">
                        <div className="glass-dark p-6 rounded-2xl border dark:border-white/5 border-black/5">
                            ...
                            <p className="dark:text-slate-400 text-slate-600 text-sm">चाहे आप झोपड़ी या बांस के शेड (bamboo shed) से शुरुआत करना चाहें या पूरी तरह से ऑटोमेटेड कंक्रीट का फार्म बनाना चाहें, हमारी टीम रांची में बेस्ट mushroom farm setup सर्विसेज देती है। <Link href="/services/turnkey-setup" className="text-primary-start hover:underline">Turnkey setup details.</Link></p>
                        </div>
                        <div className="glass-dark p-6 rounded-2xl border dark:border-white/5 border-black/5">
                            <h3 className="text-lg font-bold dark:text-white text-slate-900 mb-2">2. Online & Offline Training</h3>
                            <p className="dark:text-slate-400 text-slate-600 text-sm mb-2"><strong>Online Training:</strong> रांची के छात्रों और वर्किंग प्रोफेशनल्स के लिए हमारा <Link href="/training" className="text-primary-start hover:underline">Online Mushroom Training</Link> प्रोग्राम सबसे बेस्ट है। इसमें हम वीडियो और लाइव सेशन के जरिए पूरी साइंटिफिक विधि सिखाते हैं।</p>
                            <p className="dark:text-slate-400 text-slate-600 text-sm"><strong>Offline Training:</strong> हमारे रांची और ओरमांझी के प्रशिक्षण केंद्रों पर <Link href="/workshop" className="text-primary-start hover:underline">Offline Mushroom Training</Link> और प्रैक्टिकल वर्कशॉप्स आयोजित की जाती हैं।</p>
                        </div>
                        <div className="glass-dark p-6 rounded-2xl border dark:border-white/5 border-black/5">
                            <h3 className="text-lg font-bold dark:text-white text-slate-900 mb-2">3. Spawn & Fresh/Dry Mushroom Sale</h3>
                            <p className="dark:text-slate-400 text-slate-600 text-sm mb-2">हम रांची और पूरे झारखंड के सबसे विश्वसनीय <Link href="/spawn-seed" className="text-primary-start hover:underline">mushroom spawn supplier</Link> हैं। Oyster, Button, और Milky spawn हमेशा स्टॉक में रहता है।</p>
                        ...
                        <div className="glass-dark p-6 rounded-2xl border dark:border-white/5 border-black/5">
                            ...
                            <p className="dark:text-slate-400 text-slate-600 text-sm">हम <Link href="/services/consultancy" className="text-primary-start hover:underline">Mushroom Consultancy</Link>, झारखंड सरकार की सब्सिडी सपोर्ट, और मार्केटिंग नेटवर्क में मदद करते हैं ताकि आप सही दाम पर अपना उत्पाद बेच सकें।</p>
                        </div>
                    </div>

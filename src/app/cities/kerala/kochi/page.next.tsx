            ...
            <article className="max-w-4xl mx-auto px-4 prose prose-invert">
                <div className="glass p-8 md:p-12 rounded-[3.5rem] border dark:border-white/5 border-black/5 space-y-8">
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-6 mt-4">
                        <em>Note: കൃത്യമായ investment തീരുമാനിക്കാൻ ഒരു detailed <Link href="/business-plan" className="text-primary-start hover:underline">mushroom farming project report</Link> തയ്യാറാക്കേണ്ടത് അത്യാവശ്യമാണ്.</em>
                    </p>
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-6">
                        ഗുണനിലവാരമുള്ള <Link href="/spawn-seed" className="text-primary-start hover:underline">Spawn (വിത്ത്)</Link> ആണ് വിജയത്തിന്റെ അടിസ്ഥാനം. Oyster (Grey, Pink, Phoenix, King), Milky, Button, Shiitake, Reishi, Lion's Mane തുടങ്ങിയവയുടെ spawn നിലവിൽ ലഭ്യമാണ്.
                    </p>
                    <ul className="list-disc pl-6 space-y-4 dark:text-slate-300 text-slate-700">
                        <li>
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
                        കേരളത്തിൽ സർക്കാർ തലത്തിൽ പല <Link href="/subsidy" className="text-primary-start hover:underline">സബ്സിഡികളും</Link> ലഭ്യമാണ്:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 dark:text-slate-300 text-slate-700">
                    ...
                    <div className="space-y-6 mb-8">
                        ...
                        <div className="bg-black/5 dark:bg-white/5 p-6 rounded-2xl border border-black/5 dark:border-white/5">
                            ...
                            <p className="text-sm dark:text-slate-300 text-slate-700"><Link href="/articles/oyster-mushroom-cultivation-process" className="text-primary-start hover:underline">Oyster mushroom</Link> ആണ് ഏറ്റവും എളുപ്പത്തിൽ ചെയ്യാൻ സാധിക്കുന്നത്.</p>
                        </div>
                        <div className="bg-black/5 dark:bg-white/5 p-6 rounded-2xl border border-black/5 dark:border-white/5">
                        ...
                        <div className="bg-black/5 dark:bg-white/5 p-6 rounded-2xl border border-black/5 dark:border-white/5">
                            ...
                            <p className="text-sm dark:text-slate-300 text-slate-700">ഉണ്ട്. <Link href="/turnkey-projects" className="text-primary-start hover:underline">Turnkey projects</Link> വഴി infrastructure, equipment, staff training ഉൾപ്പെടെ എല്ലാം ചെയ്തു തരുന്നതാണ്.</p>
                        </div>
                    </div>

                ...
                <div className="glass p-8 md:p-12 rounded-[3.5rem] border dark:border-white/5 border-black/5 space-y-8">
                    ...
                    <div className="space-y-6 mt-6">
                        <div>
                            ...
                            <p className="dark:text-slate-400 text-slate-600">One of the most beginner-friendly mushroom varieties. <Link href="/services/oyster-mushroom" className="text-primary-start hover:underline">Learn more about Oyster mushrooms</Link>.</p>
                        </div>
                        <div>
                            <h3 className="text-xl font-bold dark:text-white text-slate-900 mb-2">Button Mushroom Farming</h3>
                            <p className="dark:text-slate-400 text-slate-600">Highly popular among households, restaurants and retailers. <Link href="/services/button-mushroom" className="text-primary-start hover:underline">Explore Button mushroom cultivation</Link>.</p>
                        </div>
                        <div>
                            <h3 className="text-xl font-bold dark:text-white text-slate-900 mb-2">Milky Mushroom Farming</h3>
                            <p className="dark:text-slate-400 text-slate-600">Suitable for commercial production in many regions. <Link href="/services/milky-mushroom" className="text-primary-start hover:underline">Find out about Milky mushrooms</Link>.</p>
                        </div>
                        <div>
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
                        A successful <Link href="/services/turnkey-setup" className="text-primary-start hover:underline">Mushroom Farm Setup</Link> requires:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 dark:text-slate-300 text-slate-700">
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
                        घर बैठे मशरूम खेती सीखने के लिए <Link href="/training/online" className="text-primary-start hover:underline">Online Mushroom Training</Link> उपलब्ध है।
                    </p>
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
                        Practical <Link href="/training/offline" className="text-primary-start hover:underline">offline training</Link> may include:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 dark:text-slate-300 text-slate-700">
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
                        Quality <Link href="/services/spawn-supply" className="text-primary-start hover:underline">spawn</Link> is one of the most important factors in successful mushroom production.
                    </p>
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
                        <Link href="/services/consultancy" className="text-primary-start hover:underline">Consultancy support</Link> may help with:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 dark:text-slate-300 text-slate-700">
                        <li>Farm Planning</li>
                    ...
                    <p className="dark:text-slate-300 text-slate-700 leading-relaxed mt-4">
                        A proper <Link href="/blog/mushroom-farming-business-plan-india" className="text-primary-start hover:underline">business plan</Link> supports long-term sustainability.
                    </p>
                    ...
                    <div className="bg-linear-to-r from-primary-start/20 to-primary-end/20 p-8 rounded-3xl mt-12 border border-primary-start/20">
                        ...
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed mb-4">
                            नोएडा और आसपास के क्षेत्रों में Mushroom Farming तेजी से बढ़ता हुआ एग्री-बिजनेस अवसर है। सही प्रशिक्षण, गुणवत्तापूर्ण <Link href="/services/spawn-supply" className="text-primary-start hover:underline">Mushroom Spawn</Link>, उचित Farm Setup, Marketing Support और <Link href="/blog/mushroom-farming-business-plan-india" className="text-primary-start hover:underline">Business Planning</Link> के माध्यम से किसान, छात्र और उद्यमी सफल Mushroom Business स्थापित कर सकते हैं।
                        </p>

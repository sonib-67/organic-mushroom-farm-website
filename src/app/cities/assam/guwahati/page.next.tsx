        ...
        <div className="min-h-screen pt-32 pb-20 relative overflow-hidden">
            ...
            <article className="max-w-4xl mx-auto px-4 prose prose-invert">
                ...
                <div className="mb-6 flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <span className="text-slate-400">/</span>
                    <Link href="/states/assam" className="hover:text-brand-blue transition-colors">Assam</Link>
                    <span className="text-slate-400">/</span>
                ...
                <div className="glass p-6 md:p-12 rounded-[2.5rem] border dark:border-white/5 border-black/5 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 pl-0 list-none">
                            <li className="flex gap-2 items-start"><CheckCircle2 size={16} className="text-emerald-500 shrink-0 mt-1.5" /> <span className="dark:text-slate-300 text-slate-700"><strong>Humidity 70-90%</strong> — যিটো <Link href="/mushroom-types" className="text-emerald-500 hover:underline">oyster</Link> আৰু <Link href="/mushroom-types" className="text-emerald-500 hover:underline">button mushroom</Link> ৰ বাবে আদৰ্শ</span></li>
                            ...
                            <li className="flex gap-2 items-start"><CheckCircle2 size={16} className="text-emerald-500 shrink-0 mt-1.5" /> <span className="dark:text-slate-300 text-slate-700"><strong>Winter (November-February)</strong> — <Link href="/mushroom-types" className="text-emerald-500 hover:underline">button mushroom</Link> আৰু <Link href="/mushroom-types" className="text-emerald-500 hover:underline">milky mushroom</Link> ৰ বাবে সৰ্বোত্তম সময়</span></li>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="grid grid-cols-2 gap-3 pl-0 list-none">
                            <li className="flex gap-2 items-center"><CheckCircle2 size={16} className="text-emerald-500" /> <span className="dark:text-slate-300 text-slate-700 text-sm"><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Oyster Mushroom</Link> Spawn</span></li>
                            <li className="flex gap-2 items-center"><CheckCircle2 size={16} className="text-emerald-500" /> <span className="dark:text-slate-300 text-slate-700 text-sm"><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Button Mushroom</Link> Spawn</span></li>
                            <li className="flex gap-2 items-center"><CheckCircle2 size={16} className="text-emerald-500" /> <span className="dark:text-slate-300 text-slate-700 text-sm"><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Milky Mushroom</Link> Spawn</span></li>
                            <li className="flex gap-2 items-center"><CheckCircle2 size={16} className="text-emerald-500" /> <span className="dark:text-slate-300 text-slate-700 text-sm"><Link href="/mushroom-types" className="text-emerald-500 hover:underline">Shiitake Mushroom</Link> Spawn</span></li>
                        </ul>
                        <p className="dark:text-slate-300 text-slate-700 leading-relaxed text-sm">
                    ...
                    <div className="space-y-6 pt-8 border-t dark:border-white/10 border-black/10">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="dark:bg-white/5 bg-black/5 p-5 rounded-2xl border border-white/5">
                                <h4 className="font-bold dark:text-white text-slate-950 text-sm mb-1.5">3. <Link href="/spawn-seed" className="hover:text-emerald-500 transition-colors">Mushroom spawn</Link> ক'ত পাম?</h4>
                            ...
                            <div className="dark:bg-white/5 bg-black/5 p-5 rounded-2xl border border-white/5">
                                <h4 className="font-bold dark:text-white text-slate-950 text-sm mb-1.5">4. <Link href="/training" className="hover:text-emerald-500 transition-colors">Training</Link> kaise join karein?</h4>
                            ...
                            <div className="dark:bg-white/5 bg-black/5 p-5 rounded-2xl border border-white/5">
                                <h4 className="font-bold dark:text-white text-slate-950 text-sm mb-1.5">5. <Link href="/training" className="hover:text-emerald-500 transition-colors">Online training</Link> uplabdh hai kya?</h4>
                            ...
                            <div className="dark:bg-white/5 bg-black/5 p-5 rounded-2xl border border-white/5">
                                <h4 className="font-bold dark:text-white text-slate-950 text-sm mb-1.5">6. <Link href="/training" className="hover:text-emerald-500 transition-colors">Offline training</Link> Guwahati ত পাম নে?</h4>
                            ...
                            <div className="dark:bg-white/5 bg-black/5 p-5 rounded-2xl border border-white/5">
                                <h4 className="font-bold dark:text-white text-slate-950 text-sm mb-1.5">10. <Link href="/subsidy" className="hover:text-emerald-500 transition-colors">Government subsidy</Link> uplabdh hai kya?</h4>
                            ...
                            <div className="dark:bg-white/5 bg-black/5 p-5 rounded-2xl border border-white/5">
                                <h4 className="font-bold dark:text-white text-slate-950 text-sm mb-1.5">13. Aap <Link href="/book-consultant" className="hover:text-emerald-500 transition-colors">consultancy</Link> dete hain kya?</h4>
                            ...
                            <div className="dark:bg-white/5 bg-black/5 p-5 rounded-2xl border border-white/5">
                                <h4 className="font-bold dark:text-white text-slate-950 text-sm mb-1.5">14. <Link href="/turnkey-projects" className="hover:text-emerald-500 transition-colors">Turnkey project</Link> bhi milta hai?</h4>
                    ...
                    <div className="bg-gradient-to-r from-emerald-500/20 to-teal-500/20 p-8 rounded-3xl mt-12 border border-emerald-500/20 text-center">
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <Link href="/contact" className="btn-primary px-6 py-3 rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-emerald-500/20">

          ...
          <ul className="space-y-4 my-6">
            ...
            <li className="flex gap-3 items-start">
              ...
              <div>
                ...
                No confusing information gaps. You learn the entire process chronologically—from sterilizing your straw and inoculating <Link href="/spawn-seeds" className="text-primary-start hover:underline font-semibold">spawn</Link> to managing humidity and harvesting your first flush.
              </div>
            </li>
            <li className="flex gap-3 items-start">
              <CheckCircle2 className="text-primary-start shrink-0 mt-1" size={20} />
          ...
          <ul className="space-y-4 my-6">
            <li className="flex gap-3 items-start">
              ...
              <div>
                ...
                Choosing the right high-demand variety (<Link href="/services/oyster-mushroom" className="text-primary-start hover:underline font-semibold">Oyster</Link>, <Link href="/services/milky-mushroom" className="text-primary-start hover:underline font-semibold">Milky</Link>, or <Link href="/services/button-mushroom" className="text-primary-start hover:underline font-semibold">Button</Link>) for your local climate and budget.
              </div>
            </li>
            <li className="flex gap-3 items-start">
              <CheckCircle2 className="text-primary-start shrink-0 mt-1" size={20} />

        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="border-t dark:border-white/10 border-black/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
             ...
             <div className="flex gap-6 text-sm dark:text-slate-400 text-slate-500">
               <Link href="/terms" className="hover:dark:text-white text-slate-900 transition-colors">Terms</Link>
               <Link href="/privacy" className="hover:dark:text-white text-slate-900 transition-colors">Privacy</Link>
               <Link href="/refund-policy" className="hover:dark:text-white text-slate-900 transition-colors">Refund Policy</Link>
             </div>
          </div>
        </div>
      </footer>

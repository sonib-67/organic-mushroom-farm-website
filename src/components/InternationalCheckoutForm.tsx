...
const InternationalCheckoutForm = ({ planName, price, onSuccess, onClose }: CheckoutProps) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden relative border border-slate-200 dark:border-white/10 animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-6 md:p-8">
          <div className="mb-6">
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Checkout</h3>
          ...
          {step === 2 && (
            <div className="space-y-4">
               <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 mb-6">
                 <p className="text-xs text-blue-600 dark:text-blue-400 font-semibold mb-1">Billing Details</p>
                  ...
                  onApprove={async (data, actions) => {
                    ...
                    try {
                      ...
                      if (captureData.status === "COMPLETED") {
                        ...
                        handleFailure("Payment was not completed successfully.");
                      }
                    } catch (err) {
                      setIsLoading(false);
                      handleFailure("An error occurred while confirming payment.");
                    }
                  }}
                  onCancel={() => {
